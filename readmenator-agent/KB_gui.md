...
- Symbols:
  ...
  - `rc_defer_col` (struct, line 6246)
  - `rc_defer` (struct, line 6253)
  - `freebug_window` (struct, line 12860)
  ...
  - `key` (type_alias, line 6246) `typedef struct rc_defer_col { int key;`
  - `col` (type_alias, line 6253) `typedef struct rc_defer { rc_defer_col col[RC_DEFER_COLS];`
...
static do...`
  ...
  - `defer_key_block` (function, line 6274) `static int defer_key_block(const rd_block *bk)`
  - `defer_append` (function, line 6396) `static int defer_append(rc_defer *d, int key, int side,
                        int ml, int mlpct...`
  - `defer_flush` (function, line 6431) `static void defer_flush(cairo_t *cr, const browser_window *w, rc_layout *L,
                     ...`
  - `layout_float_band` (function, line 6652) `static void layout_float_band(cairo_t *cr, const browser_window *w, rc_layout *L,
               ...`
  - `thumbnail` (function, line 6735) `* is what made a wikipedia thumbnail (a 250px image and its caption, no
     * declared width) sp...`
  - `layout_doc` (function, line 7010) `static void layout_doc(cairo_t *cr, const browser_window *w, double content_w,
                  ...`
  - `position_doc` (function, line 7381) `static void position_doc(cairo_t *cr, const browser_window *w, double content_w,
                ...`
  - `input_box_width` (function, line 7539) `static double input_box_width(double content_w)`
  - `select_box_width` (function, line 7542) `static double select_box_width(double content_w)`
  - `button_box_width` (function, line 7548) `static double button_box_width(cairo_t *cr, const ui_theme *th, const rd_block *b,
              ...`
  - `v_read` (function, line 8128) `static int v_read(int fd, void *buf, size_t n)`
  - `dies` (function, line 8156) `* child dies (exec failed, device busy, daemon absent) is detected on the
 * next PCM write (EPIP...`
  - `audio_spawn` (function, line 8164) `static void audio_spawn(browser_window *w, int rate, int channels)`
  - `audio_mark_dead` (function, line 8219) `static void audio_mark_dead(browser_window *w)`
  - `audio_write` (function, line 8236) `static void audio_write(browser_window *w, const uint8_t *data, size_t len)`
  - `audio_stop` (function, line 8250) `static void audio_stop(browser_window *w)`
  - `video_stop` (function, line 8270) `static void video_stop(browser_window *w)`
  - `video_fetch` (function, line 8449) `static sf_status video_fetch(const char *url, browser_window *w,
                              sf...`
  - `video_play` (function, line 8466) `static int video_play(browser_window *w, const char *m3u8_url)`
  - `video_stop` (function, line 8568) `* each segment loop so a video_stop() in the main thread (which sets it to 0
 * then calls pthrea...`
  - `paint_video_row` (function, line 8621) `static void paint_video_row(cairo_t *cr, browser_window *w, const rd_block *blk,
                ...`
  - `row_line_slack` (function, line 8734) `static double row_line_slack(const rc_layout *L, const rc_row *r, double content_w)`
  - `row_align_offset` (function, line 8746) `static double row_align_offset(const rc_layout *L, const rc_row *r, double content_w)`
  - `upstream` (function, line 8774) `* upstream (see spec/css.md). */
static void box_path4(cairo_t *cr, double x, double y, double w,...`
  - `box_path` (function, line 8802) `static void box_path(cairo_t *cr, double x, double y, double w, double h, double r)`
  - `text` (function, line 8819) `* fill and gradient text (2026-07-19). */
static cairo_pattern_t *bui_linear_grad(double x, doubl...`
  - `bui_grad_color_at` (function, line 8844) `static ui_rgb bui_grad_color_at(const int *cols, const int *pos1000, int nst,
                   ...`
  - `spaced` (function, line 8875) `* or evenly spaced (bui_grad_color_at). */
static void bui_paint_conic(cairo_t *cr, double x, dou...`
  - `paint_bg_layer` (function, line 8907) `static void paint_bg_layer(cairo_t *cr, const rc_box *bx, const ui_bg_image *img,
               ...`
  - `paint_box_decoration` (function, line 8950) `static void paint_box_decoration(cairo_t *cr, const rc_box *bx, double ox, double oy,
           ...`
  - `cairo_set_dash` (function, line 9113) `cairo_set_dash(cr, (double[])`
  - `cairo_set_dash` (function, line 9116) `cairo_set_dash(cr, (double[])`
  - `cairo_set_dash` (function, line 9155) `cairo_set_dash(cr, (double[])`
  - `cairo_set_dash` (function, line 9158) `cairo_set_dash(cr, (double[])`
  - `set_rgb` (function, line 9192) `set_rgb(cr, (ui_rgb)`
  - `cairo_set_dash` (function, line 9215) `cairo_set_dash(cr, (double[])`
  - `cairo_set_dash` (function, line 9218) `cairo_set_dash(cr, (double[])`
  - `paint_deco_line` (function, line 9276) `static void paint_deco_line(cairo_t *cr, double x0, double x1, double ly,
                       ...`
  - `cairo_set_dash` (function, line 9310) `cairo_set_dash(cr, (double[])`
  - `cairo_set_dash` (function, line 9312) `cairo_set_dash(cr, (double[])`
  - `paint_svg_at` (function, line 9332) `static void paint_svg_at(cairo_t *cr, const rd_block *blk, int cur,
                         doub...`
  - `replaced_current_color` (function, line 9352) `static int replaced_current_color(const browser_window *w, const rd_block *blk)`
  - `paint_inline_replaced` (function, line 9361) `static void paint_inline_replaced(cairo_t *cr, browser_window *w,
                               ...`
  - `paint_content_row` (function, line 9380) `static void paint_content_row(cairo_t *cr, browser_window *w, const rc_layout *L,
               ...`
  - `ov_box_clips` (function, line 9569) `static int ov_box_clips(const pv_box_def *d)`
  - `ov_collect_chain` (function, line 9576) `static int ov_collect_chain(const rd_doc *doc, int block_id, int *out, int cap)`
  - `ov_box_bounds` (function, line 9597) `static int ov_box_bounds(const rc_layout *L, int bid, rc_box *out)`
  - `ov_content_rect` (function, line 9621) `static void ov_content_rect(const rc_box *bx, const pv_box_def *d,
                            do...`
  - `fragment` (function, line 9641) `* first fragment (rc_frag.block_id, stamped at flow_emit_frag time) -- using
 * blk->block_id alo...`
  - `box_forms_stacking_context` (function, line 9696) `static int box_forms_stacking_context(const pv_box_def *def)`
  - `bui_skew_tan` (function, line 9739) `static double bui_skew_tan(int deg)`
  - `box_transform_matrix` (function, line 9745) `static void box_transform_matrix(const pv_box_def *def, double box_x, double box_y,
             ...`
  - `bui_blend_operator` (function, line 9864) `static cairo_operator_t bui_blend_operator(int mix_blend)`
  - `bui_paint_backdrop_blur` (function, line 10002) `static void bui_paint_backdrop_blur(cairo_t *cr, const pv_box_def *def,
                         ...`
  - `bui_pop_group_composite` (function, line 10060) `static void bui_pop_group_composite(cairo_t *cr, const pv_box_def *def, uint64_t elapsed_ms)`
  - `limits` (function, line 10290) `* documents narrower v1 limits (no overflow:hidden, no negative z-index). A box
 * grouped this w...`
  - `paint_box_decoration_grouped` (function, line 10358) `static void paint_box_decoration_grouped(cairo_t *cr, browser_window *w,
                        ...`
  - `paint_box_and_direct_rows` (function, line 10399) `static void paint_box_and_direct_rows(cairo_t *cr, browser_window *w, const rc_layout *L,
       ...`
  - `paint_positioned_one` (function, line 10494) `static void paint_positioned_one(cairo_t *cr, browser_window *w, const ui_theme *th,
            ...`
  - `paint_nested_children` (function, line 10683) `static void paint_nested_children(cairo_t *cr, browser_window *w,
                               ...`
  - `paint_structured` (function, line 10715) `static void paint_structured(cairo_t *cr, browser_window *w, double content_top,
                ...`
  - `write_doc_pdf` (function, line 10933) `static long write_doc_pdf(browser_window *w, const char *path)`
  - `export_pdf` (function, line 11038) `static void export_pdf(browser_window *w)`
  - `write_doc_png` (function, line 11102) `static long write_doc_png(browser_window *w, const char *path)`
  - `export_png` (function, line 11223) `static void export_png(browser_window *w)`
  - `caller` (function, line 11258) `* caller (freedom.c --download-pdf) owns the fetch/parse pipeline and supplies the
 * out_path ve...`
  - `ui_render_png` (function, line 11281) `ui_status ui_render_png(const rd_doc *doc, const char *out_path, long *out_h)`
  - `render_doc_images` (function, line 11307) `static ui_status render_doc_images(const rd_doc *doc, tab *t, const char *top_url,
              ...`
  - `ui_render_png_images` (function, line 11337) `ui_status ui_render_png_images(const rd_doc *doc, tab *t, const char *top_url,
                  ...`
  - `ui_render_pdf_images` (function, line 11343) `ui_status ui_render_pdf_images(const rd_doc *doc, tab *t, const char *top_url,
                  ...`
  - `ui_dump_layout` (function, line 11359) `ui_status ui_dump_layout(const rd_doc *doc)`
  - `link_at_point` (function, line 11420) `static const char *link_at_point(browser_window *w, double px, double py)`
  - `resolve_box_cursor` (function, line 11514) `static int resolve_box_cursor(const rd_doc *doc, int block_id)`
  - `box_pointer_events_none` (function, line 11528) `static int box_pointer_events_none(const rd_doc *doc, int block_id)`
  - `cursor_at_point` (function, line 11544) `static int cursor_at_point(browser_window *w, double px, double py)`
  - `node_at_point` (function, line 11596) `static dom_node_id node_at_point(browser_window *w, double px, double py)`
  - `reference` (function, line 11644) `* reference (downgrade, foreign scheme, no resolvable base) navigates nowhere:
 * hostile content...`
  - `apply_click_result` (function, line 11665) `static void apply_click_result(browser_window *w, tab_page *page)`
  - `memory` (function, line 11688) `* memory (the href pointer, not its contents, was all the old code preserved). */
static void dis...`
  - `GET` (function, line 11771) `* the network under weaker rules than a GET (Zero Trust). */
static void do_submit_post(browser_w...`
  - `ensure_download_dir` (function, line 11805) `static int ensure_download_dir(char *out, size_t outsz)`
  - `write_file_atomic` (function, line 11820) `static int write_file_atomic(const char *path, const void *bytes, size_t len)`
  - `save_download` (function, line 11842) `static void save_download(browser_window *w, const char *url, const char *bytes,
                ...`
  - `save_current_page` (function, line 11875) `static void save_current_page(browser_window *w)`
  - `deliver_fetch_result` (function, line 11884) `static void deliver_fetch_result(browser_window *w, fetch_job *j)`
  - `drain_fetch_results` (function, line 11939) `static void drain_fetch_results(browser_window *w)`
  - `toggle_reader` (function, line 12015) `static void toggle_reader(browser_window *w)`
  - `menu_item_checked` (function, line 12026) `static int menu_item_checked(const browser_window *w, size_t i)`
  - `menu_item_toggle` (function, line 12048) `static void menu_item_toggle(browser_window *w, size_t i)`
  - `draw_clock` (function, line 12158) `static void draw_clock(cairo_t *cr, ui_rgb color, double cx, double cy, double r,
               ...`
  - `draw_hamburger` (function, line 12169) `static void draw_hamburger(cairo_t *cr, ui_rgb color, double bx, double ttop)`
  - `draw_reload` (function, line 12186) `static void draw_reload(cairo_t *cr, ui_rgb color, double bx, double ttop)`
  - `draw_menu` (function, line 12208) `static void draw_menu(cairo_t *cr, browser_window *w)`
  - `draw_hover_url` (function, line 12319) `static double draw_hover_url(cairo_t *cr, browser_window *w)`
  - `draw_toast` (function, line 12351) `static void draw_toast(cairo_t *cr, browser_window *w, double bottom_offset)`
  - `draw_tabstrip` (function, line 12381) `static void draw_tabstrip(cairo_t *cr, browser_window *w)`
  - `draw_omnibox` (function, line 12436) `static void draw_omnibox(cairo_t *cr, browser_window *w)`
  - `paint` (function, line 12469) `static void paint(browser_window *w)`
  - `redraw` (function, line 12713) `static void redraw(browser_window *w)`
  - `wm_base_ping` (function, line 12725) `static void wm_base_ping(void *data, struct xdg_wm_base *b, uint32_t serial)`
  - `xdg_surface_configure` (function, line 12731) `static void xdg_surface_configure(void *data, struct xdg_surface *s, uint32_t serial)`
  - `toplevel_configure` (function, line 12739) `static void toplevel_configure(void *data, struct xdg_toplevel *t,
                              ...`
  - `wl_array_for_each` (function, line 12756) `wl_array_for_each(st, states)`
  - `toplevel_close` (function, line 12762) `static void toplevel_close(void *data, struct xdg_toplevel *t)`
  - `deco_configure` (function, line 12770) `static void deco_configure(void *data, struct zxdg_toplevel_decoration_v1 *d, uint32_t mode)`
  - `set_cursor` (function, line 12783) `static void set_cursor(browser_window *w, int cur_kind)`
  - `element` (function, line 12813) `* cursor:pointer element (a JS-driven button/div, not just an <a>) shows the hand
 * even without...`
  - `fbw_split_y` (function, line 12883) `static double fbw_split_y(const freebug_window *fb)`
  - `freebug_ensure_buffer` (function, line 12891) `static int freebug_ensure_buffer(freebug_window *fb)`
  - `fbw_level_rgb` (function, line 12919) `static void fbw_level_rgb(int level, double *r, double *g, double *b)`
  - `fbw_console_lines` (function, line 12930) `static size_t fbw_console_lines(const fb_buffer *log)`
  - `freebug_paint` (function, line 12942) `static void freebug_paint(freebug_window *fb)`
  - `freebug_redraw_fb` (function, line 13141) `static void freebug_redraw_fb(freebug_window *fb)`
  - `freebug_redraw` (function, line 13150) `static void freebug_redraw(browser_window *w)`
  - `freebug_hide` (function, line 13154) `static void freebug_hide(browser_window *w)`
  - `fbw_xdg_surface_configure` (function, line 13170) `static void fbw_xdg_surface_configure(void *data, struct xdg_surface *s, uint32_t serial)`
  - `fbw_toplevel_configure` (function, line 13178) `static void fbw_toplevel_configure(void *data, struct xdg_toplevel *t,
                          ...`
  - `fbw_toplevel_close` (function, line 13188) `static void fbw_toplevel_close(void *data, struct xdg_toplevel *t)`
  - `freebug_show` (function, line 13197) `static void freebug_show(browser_window *w)`
  - `freebug_toggle` (function, line 13227) `static void freebug_toggle(browser_window *w)`
  - `freebug_destroy` (function, line 13232) `static void freebug_destroy(browser_window *w)`
  - `freebug_owns_surface` (function, line 13239) `static int freebug_owns_surface(const browser_window *w, const struct wl_surface *sf)`
  - `freebug_is_open` (function, line 13243) `static int freebug_is_open(const browser_window *w)`
  - `freebug_repl_worker` (function, line 13251) `static tab *freebug_repl_worker(browser_window *w)`
  - `freebug_eval` (function, line 13287) `static void freebug_eval(browser_window *w)`
  - `freebug_handle_key` (function, line 13327) `static void freebug_handle_key(browser_window *w, xkb_keysym_t sym,
                             ...`
  - `freebug_pointer_button` (function, line 13362) `static void freebug_pointer_button(browser_window *w, uint32_t serial,
                          ...`
  - `freebug_pointer_motion` (function, line 13381) `static void freebug_pointer_motion(browser_window *w)`
  - `freebug_pointer_axis` (function, line 13403) `static void freebug_pointer_axis(browser_window *w, wl_fixed_t value)`
  - `ptr_enter` (function, line 13421) `static void ptr_enter(void *d, struct wl_pointer *p, uint32_t s,
                      struct wl_...`
  - `ptr_leave` (function, line 13440) `static void ptr_leave(void *d, struct wl_pointer *p, uint32_t s, struct wl_surface *sf)`
  - `ptr_motion` (function, line 13457) `static void ptr_motion(void *d, struct wl_pointer *p, uint32_t t, wl_fixed_t x, wl_fixed_t y)`
  - `load_current` (function, line 13481) `static void load_current(browser_window *w)`
  - `go_omnibox` (function, line 13495) `static void go_omnibox(browser_window *w)`
  - `ptr_button` (function, line 13539) `static void ptr_button(void *d, struct wl_pointer *p, uint32_t serial, uint32_t t,
              ...`
  - `scroll_line_px` (function, line 13769) `static double scroll_line_px(const browser_window *w)`
  - `ptr_axis` (function, line 13772) `static void ptr_axis(void *data, struct wl_pointer *p, uint32_t time,
                     uint32...`
  - `ptr_frame` (function, line 13796) `static void ptr_frame(void *d, struct wl_pointer *p)`
  - `mime_is_text` (function, line 13813) `static int mime_is_text(const char *mime)`
  - `data_offer_source_actions` (function, line 13831) `static void data_offer_source_actions(void *d, struct wl_data_offer *o, uint32_t a)`
  - `data_offer_action` (function, line 13834) `static void data_offer_action(void *d, struct wl_data_offer *o, uint32_t a)`
  - `data_device_data_offer` (function, line 13844) `static void data_device_data_offer(void *data, struct wl_data_device *dev,
                      ...`
  - `data_device_selection` (function, line 13856) `static void data_device_selection(void *data, struct wl_data_device *dev,
                       ...`
  - `data_device_enter` (function, line 13875) `static void data_device_enter(void *d, struct wl_data_device *dev, uint32_t serial,
             ...`
  - `data_device_leave` (function, line 13880) `static void data_device_leave(void *d, struct wl_data_device *dev)`
  - `data_device_motion` (function, line 13881) `static void data_device_motion(void *d, struct wl_data_device *dev, uint32_t t,
                 ...`
  - `data_device_drop` (function, line 13885) `static void data_device_drop(void *d, struct wl_data_device *dev)`
  - `data_source_cancelled` (function, line 13896) `static void data_source_cancelled(void *data, struct wl_data_source *src)`
  - `data_source_send` (function, line 13902) `static void data_source_send(void *data, struct wl_data_source *src,
                            ...`
  - `data_source_target` (function, line 13915) `static void data_source_target(void *d, struct wl_data_source *s, const char *m)`
  - `freebug_copy_console` (function, line 13927) `static void freebug_copy_console(browser_window *w)`
  - `insert_pasted_text` (function, line 13985) `static void insert_pasted_text(browser_window *w, const char *text, size_t len)`
  - `clipboard_copy` (function, line 14049) `static void clipboard_copy(browser_window *w)`
  - `keyboard_keymap` (function, line 14096) `static void keyboard_keymap(void *data, struct wl_keyboard *kbd,
                            uint...`
  - `keyboard_enter` (function, line 14117) `static void keyboard_enter(void *d, struct wl_keyboard *kbd, uint32_t s,
                        ...`
  - `keyboard_leave` (function, line 14125) `static void keyboard_leave(void *d, struct wl_keyboard *kbd, uint32_t s, struct wl_surface *sf)`
  - `key_sym_to_js_key` (function, line 14133) `static const char *key_sym_to_js_key(xkb_keysym_t sym)`
  - `key_sym_to_keycode` (function, line 14159) `static int key_sym_to_keycode(xkb_keysym_t sym)`
  - `dispatch_js_event` (function, line 14184) `static void dispatch_js_event(browser_window *w, dom_node_id node_id,
                           ...`
  - `handle_key_press` (function, line 14241) `static void handle_key_press(browser_window *w, xkb_keysym_t sym, const char *utf8,
             ...`
  - `key_is_repeatable` (function, line 14571) `static int key_is_repeatable(xkb_keysym_t sym, int n, int ctrl)`
  - `key_repeat_arm` (function, line 14587) `static void key_repeat_arm(browser_window *w, uint32_t key)`
  - `key_repeat_stop` (function, line 14600) `static void key_repeat_stop(browser_window *w)`
  - `key_repeat_fire` (function, line 14611) `static void key_repeat_fire(browser_window *w)`
  - `keyboard_key` (function, line 14624) `static void keyboard_key(void *data, struct wl_keyboard *kbd, uint32_t serial,
                  ...`
  - `keyboard_modifiers` (function, line 14664) `static void keyboard_modifiers(void *data, struct wl_keyboard *kbd, uint32_t s,
                 ...`
  - `keyboard_repeat_info` (function, line 14674) `static void keyboard_repeat_info(void *d, struct wl_keyboard *kbd, int32_t rate, int32_t delay)`
  - `seat_caps` (function, line 14692) `static void seat_caps(void *data, struct wl_seat *seat, uint32_t caps)`
  - `seat_name` (function, line 14704) `static void seat_name(void *d, struct wl_seat *s, const char *name)`
  - `registry_global` (function, line 14710) `static void registry_global(void *data, struct wl_registry *reg, uint32_t name,
                 ...`
  - `registry_remove` (function, line 14731) `static void registry_remove(void *d, struct wl_registry *r, uint32_t name)`
  - `ui_run_browser` (function, line 14740) `ui_status ui_run_browser(const char *start_url)`
  - `cost` (function, line 15117) `* measured cost (floor 33 ms = the existing ~30 fps ceiling):
  ...
  - `defer_founder_style` (function, line 6383) `defer_founder_style(doc, start, end, runs[r].key, &side, &ml, &mlpct, &mr, &mrpct);`
  - `fprintf` (function, line 6390) `fprintf(stderr, "[defer] band [%zu,%zu) keys=", start, end);`
  - `x` (function, line 6484) `* reported x is already the BORDER x (the §7c.2 rule);`
  - `leave_inline_box` (function, line 6895) `leave_inline_box(L, &si, bk->block_id);`
  - `chain` (function, line 7060) `* chain (the box that left the normal flow at this pen position);`
  - `first` (function, line 7122) `* flush first (no-op when nothing is deferred). */ defer_flush(cr, w, L, &s, th, content_w, doc, &df);`
  - `anchor` (function, line 7144) `* anchor (spec/float.md §7d.3) exactly like a text block. An * empty/hidden one leaves cur_top untouched, so this is a no-op * for it. Without this a flex header never anchored and pulled * columns te`
  - `key` (function, line 7203) `* founders splits by key (stories, rail, footer nav each take * their column);`
  - `have` (function, line 7217) `* as they always have (spec/float.md §6b.3). */ rc_float_clear(&s);`
  - `standalone` (function, line 7236) `* must not be treated as standalone (which would flush that line and give * the element a row of its own -- R7). */ int inline_replaced = replaced_is_inline_level(&s, b);`
  - `it` (function, line 7284) `* column: flush first so the column lands above it (source order), * then move the anchor — the image bottom is the container top * for whatever follows. */ defer_flush(cr, w, L, &s, th, content_w, do`
  - `rd_input_label` (function, line 7552) `: rd_input_label(b->input_type);`
  - `cairo_save` (function, line 7578) `cairo_save(cr);`
  - `cairo_clip` (function, line 7580) `cairo_clip(cr);`
  - `cairo_restore` (function, line 7584) `cairo_restore(cr);`
  - `cairo_set_line_width` (function, line 7594) `cairo_set_line_width(cr, lw);`
  - `cairo_arc` (function, line 7597) `cairo_arc(cr, bx + 7.0, by + 7.0, r, 0, 2 * M_PI);`
  - `cairo_stroke` (function, line 7598) `cairo_stroke(cr);`
  - `cairo_line_to` (function, line 7610) `cairo_line_to(cr, bx + 6.5, by + 10.5);`
  - `cairo_close_path` (function, line 7680) `cairo_close_path(cr);`
  - `rd_build` (function, line 7943) `* rd_build (-1 = auto/off -> theme caret). */ if (b->caret_color >= 0 && !w->force_theme) set_rgb(cr, rgb_from_packed(b->caret_color));`
  - `cairo_translate` (function, line 7980) `cairo_translate(cr, left + pad + ax, ry + pad);`
  - `cairo_scale` (function, line 7986) `cairo_scale(cr, dw / (double)im->nat_w, dh / (double)im->nat_h);`
  - `cairo_set_source_surface` (function, line 8021) `cairo_set_source_surface(cr, im->surface, 0.0, 0.0);`
  - `cairo_pattern_set_filter` (function, line 8024) `cairo_pattern_set_filter(cairo_get_source(cr), nearest ? CAIRO_FILTER_NEAREST : CAIRO_FILTER_GOOD);`
  - `cairo_paint` (function, line 8026) `cairo_paint(cr);`
  - `poll` (function, line 8137) `poll(&pfd, 1, 10);`
  - `descriptors` (function, line 8179) `* descriptors (especially the Wayland display fd) so the sink does * not corrupt the Wayland protocol connection — the most common * cause of the "page flashes white and render loops" bug. */ close(p[`
  - `dup2` (function, line 8183) `dup2(p[0], 0);`
  - `execlp` (function, line 8199) `else execlp("aplay", "aplay", "-r", rate_str, "-c", ch_str, "-f", "S16_LE", "-t", "raw", "-q", (char *)NULL);`
  - `_exit` (function, line 8202) `_exit(127);`
  - `kill` (function, line 8225) `kill(w->audio_pid, SIGKILL);`
  - `waitpid` (function, line 8226) `waitpid(w->audio_pid, NULL, 0);`
  - `again` (function, line 8260) `* before a respawn opens it again (the WNOHANG reap left the old * process alive long enough to make the new one fail with "Device * or resource busy"). Death is immediate, so the wait is too. */ kill`
  - `pthread_join` (function, line 8285) `pthread_join(w->video_thread, NULL);`
  - `hls_playlist_free` (function, line 8302) `hls_playlist_free(w->video_pl);`
  - `blocking` (function, line 8547) `* are blocking (POLLIN guaranteed data is available). */ int flags = fcntl(out_fd, F_GETFL, 0);`
  - `signal` (function, line 8576) `signal(SIGPIPE, SIG_IGN);`
  - `v_write` (function, line 8601) `v_write(w->decoder_cmd_fd, &cmd, 1);`
  - `cairo_fill_preserve` (function, line 8698) `cairo_fill_preserve(cr);`
  - `cairo_new_sub_path` (function, line 8792) `cairo_new_sub_path(cr);`
  - `box_path4` (function, line 8804) `box_path4(cr, x, y, w, h, rc);`
  - `rect` (function, line 8815) `* across rect (x,y,w,h): the gradient line runs through the rect center, long * enough that the first/last stops land on the corners. Stops at explicit * 0-1000 positions (pos1000, -1 or NULL = evenly`
  - `cairo_pattern_add_color_stop_rgba` (function, line 8835) `cairo_pattern_add_color_stop_rgba(pat, pos, sc.r, sc.g, sc.b, alpha);`
  - `rgb_from_packed` (function, line 8866) `return rgb_from_packed(cols[nst - 1] >= 0 ? cols[nst - 1] : 0);`
  - `cairo_pattern_set_extend` (function, line 8942) `cairo_pattern_set_extend(ipat, bx->bg_repeat == CSS_BGR_NO_REPEAT ? CAIRO_EXTEND_NONE : CAIRO_EXTEND_REPEAT);`
  - `cairo_set_source` (function, line 8945) `cairo_set_source(cr, ipat);`
  - `cairo_pattern_destroy` (function, line 8947) `cairo_pattern_destroy(ipat);`
  - `cairo_set_source_rgba` (function, line 8990) `cairo_set_source_rgba(cr, sc.r, sc.g, sc.b, 0.30 / (double)steps);`
  - `cairo_set_fill_rule` (function, line 9006) `cairo_set_fill_rule(cr, CAIRO_FILL_RULE_EVEN_ODD);`
  - `bui_paint_conic` (function, line 9026) `bui_paint_conic(cr, x, y, w, h, rad, bx->grad_angle, bx->grad_c, bx->grad_pos, bx->grad_n);`
  - `cairo_pattern_add_color_stop_rgb` (function, line 9038) `cairo_pattern_add_color_stop_rgb(pat, pos, sc.r, sc.g, sc.b);`
  - `layer` (function, line 9067) `* first layer (CSS multi-background: the first declared URL is the topmost) * and OVER bg_rgb/gradient, UNDER the border. Same sizing/repeat/position * as the first layer, using the SAME rc_box fields`
  - `cairo_set_line_cap` (function, line 9115) `cairo_set_line_cap(cr, CAIRO_LINE_CAP_ROUND);`
  - `convention` (function, line 9178) `* on the 3D bevel convention (light top/left, dark right/bottom). */ int is_3d = (style == CSS_BST_GROOVE || style == CSS_BST_RIDGE || style == CSS_BST_INSET || style == CSS_BST_OUTSET);`
  - `cairo_curve_to` (function, line 9291) `cairo_curve_to(cr, cx + half * 0.5, ly, cx + half * 0.5, cy, cx + half, cy);`
  - `row_owner_block_id` (function, line 9327) `static int row_owner_block_id(const rc_layout *L, const rc_row *r);`
  - `paint_image_row` (function, line 9375) `paint_image_row(cr, w, blk, x - th->image_box_pad, y - th->image_box_pad, f->repl_w + 2.0 * th->image_box_pad, f->repl_h + 2.0 * th->image_box_pad);`
  - `draw_input_row` (function, line 9421) `draw_input_row(cr, w, r->blk, left + r->x_off, cw, ry, r->ascent, r->height);`
  - `bg` (function, line 9434) `* its own DISTINCT bg (an inline span highlight) still paints. */ int own_bid = row_owner_block_id(L, r);`
  - `bx_content_clipped` (function, line 9571) `return bx_content_clipped(d->overflow_x, d->overflow_y);`
  - `rows` (function, line 9640) `* RC_IMAGE rows (see its declaration);`
  - `cx_forms_stacking_context` (function, line 9723) `return cx_forms_stacking_context(&st);`
  - `cairo_matrix_init_identity` (function, line 9749) `cairo_matrix_init_identity(m);`
  - `ip_anim_init` (function, line 9775) `ip_anim_init(&a, IP_VAL_SCALAR, &ease, prog_kf, 2, (double)def->anim_duration_ms, delay, iters, dir, fill);`
  - `ip_anim_tick` (function, line 9777) `ip_anim_tick(&a, (double)elapsed_ms);`
  - `cairo_matrix_translate` (function, line 9846) `cairo_matrix_translate(m, tx, ty);`
  - `cairo_matrix_rotate` (function, line 9848) `cairo_matrix_rotate(m, rot);`
  - `cairo_matrix_scale` (function, line 9849) `cairo_matrix_scale(m, sx, sy);`
  - `cairo_matrix_multiply` (function, line 9854) `cairo_matrix_multiply(m, &k, m);`
  - `cairo_user_to_device` (function, line 10017) `cairo_user_to_device(cr, &dx, &dy);`
  - `cairo_destroy` (function, line 10041) `cairo_destroy(scr);`
  - `bui_box_blur_surface` (function, line 10042) `bui_box_blur_surface(snap, radius);`
  - `cairo_identity_matrix` (function, line 10049) `cairo_identity_matrix(cr);`
  - `cairo_clip_extents` (function, line 10080) `cairo_clip_extents(cr, &x1, &y1, &x2, &y2);`
  - `the` (function, line 10212) `* the (already filtered) group with the shadow color, blur it, and * paint it under the group at the declared offset -- the shadow * follows the real content shape (PNG transparency, glyphs), not * th`
  - `cairo_mask_surface` (function, line 10221) `cairo_mask_surface(scr, flt_surf, 0, 0);`
  - `cairo_pop_group_to_source` (function, line 10236) `cairo_pop_group_to_source(cr);`
  - `cairo_set_operator` (function, line 10279) `cairo_set_operator(cr, bui_blend_operator(def ? def->mix_blend : CSS_MB_UNSET));`
  - `cairo_paint_with_alpha` (function, line 10280) `cairo_paint_with_alpha(cr, alpha);`
  - `cairo_push_group` (function, line 10376) `cairo_push_group(cr);`
  - `cairo_transform` (function, line 10378) `cairo_transform(cr, &m);`
  - `fill` (function, line 10388) `* fill (paint_content_row's r->bg_rgb branch) cascades the SAME author * background-color as the box, but paints in the caller's separate row pass -- * left ungrouped, it shows as a solid, un-faded re`
  - `ov_reconcile` (function, line 10454) `ov_reconcile(cr, ov_stack, &ov_depth, w->doc, bx->block_id, L, origin, left);`
  - `compositing` (function, line 10480) `* * Group compositing (M1.1 increments 3-4): a box that forms a CSS stacking context * (box_forms_stacking_context: opacity<1, mix-blend != normal, isolation:isolate, * transform != none, or the posit`
  - `cairo_show_page` (function, line 11027) `cairo_show_page(cr);`
  - `cairo_image_surface_create` (function, line 11150) `cairo_image_surface_create(CAIRO_FORMAT_ARGB32, (int)PNG_PAGE_W, (int)img_h);`
  - `origin` (function, line 11303) `* top_url is the page origin (https or file://);`
  - `printf` (function, line 11376) `printf("=== Freedom layout ===\n");`
  - `in` (function, line 11381) `* a line landed in (Stage 3), which no other dump shows. Text stays out (it is * --dump-dom's job);`
  - `fb_buffer_free` (function, line 11676) `fb_buffer_free(&w->console);`
  - `unlink` (function, line 11835) `unlink(tmp);`
  - `do_submit_post` (function, line 12006) `do_submit_post(w, &plan);`
  - `presentation` (function, line 12046) `* affect presentation (a repaint, which re-runs layout, suffices);`
  - `ui_layout_free` (function, line 12697) `ui_layout_free(&lay);`
  - `wl_surface_attach` (function, line 12718) `wl_surface_attach(w->surface, w->buffer, 0, 0);`
  - `wl_surface_damage_buffer` (function, line 12719) `wl_surface_damage_buffer(w->surface, 0, 0, w->width, w->height);`
  - `wl_surface_commit` (function, line 12720) `wl_surface_commit(w->surface);`
  - `wl_display_flush` (function, line 12721) `wl_display_flush(w->display);`
  - `xdg_wm_base_pong` (function, line 12728) `xdg_wm_base_pong(b, serial);`
  - `xdg_surface_ack_configure` (function, line 12734) `xdg_surface_ack_configure(s, serial);`
  - `resizes` (function, line 12748) `* when the window resizes (a no-op for the other modes). */ if (w->reader) apply_theme(w);`
  - `wl_pointer_set_cursor` (function, line 12803) `wl_pointer_set_cursor(w->pointer, w->pointer_serial, w->cursor_surface, (int32_t)img->hotspot_x, (int32_t)img->hotspot_y);`
  - `wl_surface_damage` (function, line 12806) `wl_surface_damage(w->cursor_surface, 0, 0, (int32_t)img->width, (int32_t)img->height);`
  - `xdg_surface_add_listener` (function, line 13214) `xdg_surface_add_listener(fb->xdg_surface, &fbw_xdg_surface_listener, fb);`
  - `xdg_toplevel_add_listener` (function, line 13216) `xdg_toplevel_add_listener(fb->xdg_toplevel, &fbw_toplevel_listener, fb);`
  - `xdg_toplevel_set_title` (function, line 13217) `xdg_toplevel_set_title(fb->xdg_toplevel, "Freebug - Freedom DevTools");`
  - `xdg_toplevel_set_app_id` (function, line 13218) `xdg_toplevel_set_app_id(fb->xdg_toplevel, "org.freedom.freebug");`
  - `zxdg_toplevel_decoration_v1_set_mode` (function, line 13221) `zxdg_toplevel_decoration_v1_set_mode(fb->deco, ZXDG_TOPLEVEL_DECORATION_V1_MODE_SERVER_SIDE);`
  - `fb_buffer_push` (function, line 13301) `fb_buffer_push(&w->console, FB_ERROR, "Freebug: no live page to evaluate (reload the page first).", 56);`
  - `fb_buffer_push_loc` (function, line 13312) `fb_buffer_push_loc(&w->console, e->level, e->text, e->len, e->file, e->line, e->col);`
  - `tab_eval_result_free` (function, line 13320) `tab_eval_result_free(&r);`
  - `tf_clear` (function, line 13323) `tf_clear(&fb->editor);`
  - `tf_insert` (function, line 13342) `tf_insert(&fb->editor, '\n');`
  - `down` (function, line 13416) `* defined further down (after dispatch_js_event) but called from ptr_enter/leave * /motion too. */ static void dispatch_mouse_event(browser_window *w, dom_node_id node_id, const char *event_type, int `
  - `update_hover` (function, line 13432) `update_hover(w);`
  - `dispatch_mouse_event` (function, line 13437) `dispatch_mouse_event(w, nid, "mouseenter", (int)w->ptr_x, (int)w->ptr_y, 0);`
  - `browser_commit_url_bar` (function, line 13532) `browser_commit_url_bar(&w->bs);`
  - `xdg_toplevel_set_maximized` (function, line 13661) `else xdg_toplevel_set_maximized(w->xdg_toplevel);`
  - `xdg_toplevel_set_minimized` (function, line 13663) `xdg_toplevel_set_minimized(w->xdg_toplevel);`
  - `xdg_toplevel_move` (function, line 13665) `xdg_toplevel_move(w->xdg_toplevel, w->seat, serial);`
  - `submit_form` (function, line 13744) `submit_form(w, ctl);`
  - `dispatch_click` (function, line 13762) `dispatch_click(w, w->ptr_x, w->ptr_y);`
  - `wl_data_offer_add_listener` (function, line 13851) `wl_data_offer_add_listener(offer, &data_offer_listener, w);`
  - `wl_data_source_destroy` (function, line 13899) `wl_data_source_destroy(src);`
  - `wl_data_source_add_listener` (function, line 13971) `wl_data_source_add_listener(w->copy_source, &data_source_listener, w);`
  - `wl_data_source_offer` (function, line 13973) `wl_data_source_offer(w->copy_source, "text/plain");`
  - `wl_data_device_set_selection` (function, line 13974) `wl_data_device_set_selection(w->data_device, w->copy_source, w->last_serial);`
  - `loop` (function, line 13976) `* we return to the event loop (without this, the clipboard offer stays queued * and a paste that follows immediately might miss it). */ wl_display_roundtrip(w->display);`
  - `browser_url_bar_insert` (function, line 13994) `browser_url_bar_insert(&w->bs, (char)c);`
  - `wl_data_offer_receive` (function, line 14015) `wl_data_offer_receive(w->selection_offer, mime, fds[1]);`
  - `wl_display_roundtrip` (function, line 14018) `wl_display_roundtrip(w->display);`
  - `browser_url_bar_delete_selection` (function, line 14092) `browser_url_bar_delete_selection(&w->bs);`
  - `munmap` (function, line 14113) `munmap(map_str, size);`
  - `tf_set` (function, line 14210) `tf_set(&w->inputs[i].field, value);`
  - `clipboard_paste` (function, line 14276) `clipboard_paste(w);`
  - `clipboard_cut` (function, line 14286) `clipboard_cut(w);`
  - `browser_url_bar_select_all` (function, line 14292) `browser_url_bar_select_all(&w->bs);`
  - `browser_add_exception` (function, line 14302) `browser_add_exception(&w->bs, host);`
  - `tf_backspace` (function, line 14425) `tf_backspace(&w->ua_field);`
  - `tf_delete` (function, line 14427) `tf_delete(&w->ua_field);`
  - `tf_move` (function, line 14429) `tf_move(&w->ua_field, -1);`
  - `tf_home` (function, line 14433) `tf_home(&w->ua_field);`
  - `tf_end` (function, line 14435) `tf_end(&w->ua_field);`
  - `browser_url_bar_backspace` (function, line 14543) `browser_url_bar_backspace(&w->bs);`
  - `browser_url_bar_delete` (function, line 14546) `browser_url_bar_delete(&w->bs);`
  - `browser_url_bar_move_cursor` (function, line 14550) `else browser_url_bar_move_cursor(&w->bs, -1);`
  - `browser_url_bar_set_cursor` (function, line 14555) `browser_url_bar_set_cursor(&w->bs, 0, shift);`
  - `timerfd_settime` (function, line 14596) `timerfd_settime(w->repeat_timer_fd, 0, &its, NULL);`
  - `xkb_state_update_mask` (function, line 14671) `xkb_state_update_mask(w->xkb_state, mods_depressed, mods_latched, mods_locked, 0, 0, group);`
  - `wl_pointer_add_listener` (function, line 14697) `wl_pointer_add_listener(w->pointer, &pointer_listener, w);`
  - `wl_keyboard_add_listener` (function, line 14701) `wl_keyboard_add_listener(w->keyboard, &keyboard_listener, w);`
  - `xdg_wm_base_add_listener` (function, line 14721) `xdg_wm_base_add_listener(w->wm_base, &wm_base_listener, w);`
  - `wl_seat_add_listener` (function, line 14724) `wl_seat_add_listener(w->seat, &seat_listener, w);`
  - `saving` (function, line 14756) `* disables saving (never clobber);`
  - `prefs_init` (function, line 14757) `prefs_init(&w.prefs);`
  - `fc_init` (function, line 14779) `fc_init(&w.fc);`
  - `sf_global_init` (function, line 14797) `sf_global_init();`
  - `fcntl` (function, line 14800) `fcntl(w.fetch_pipe[0], F_SETFL, O_NONBLOCK);`
  - `pthread_mutex_init` (function, line 14806) `pthread_mutex_init(&w.stream_lock, NULL);`
  - `browser_navigate` (function, line 14824) `else browser_navigate(&w.bs, start_url);`
  - `redraws` (function, line 14835) `* so a large page with frequent redraws (spinner, JS ticks, video frames) * never hits "Data too big for buffer". A 4 KiB buffer overflows when * accumulated messages exceed that, since manual flushes`
  - `wl_registry_add_listener` (function, line 14845) `wl_registry_add_listener(w.registry, &registry_listener, &w);`
  - `wl_display_disconnect` (function, line 14849) `wl_display_disconnect(w.display);`
  - `xkb_context_unref` (function, line 14851) `xkb_context_unref(w.xkb_ctx);`
  - `wl_data_device_add_listener` (function, line 14859) `wl_data_device_add_listener(w.data_device, &data_device_listener, &w);`
  - `zxdg_toplevel_decoration_v1_add_listener` (function, line 14873) `zxdg_toplevel_decoration_v1_add_listener(w.deco, &deco_listener, &w);`
  - `applies` (function, line 14905) `* persisted choice applies (prefs_parse already clamped it to a valid mode). */ const char *js_env = getenv("FREEDOM_JS");`
  - `wl_display_dispatch_pending` (function, line 14948) `wl_display_dispatch_pending(w.display);`
  - `wl_display_cancel_read` (function, line 15017) `wl_display_cancel_read(w.display);`
  - `flow` (function, line 15095) `* flow (counting them starved aplay). A video frame read while * overdue overwrites the held slot (standard player frame drop);`
  - `pthread_mutex_destroy` (function, line 15172) `pthread_mutex_destroy(&w.stream_lock);`
  - `prefs_free` (function, line 15193) `prefs_free(&w.prefs);`
  - `profile_close` (function, line 15194) `profile_close(&w.profile);`
  - `tsh_shutdown` (function, line 15201) `tsh_shutdown();`
  - `cairo_debug_reset_static_data` (function, line 15202) `cairo_debug_reset_static_data();`
  - `FcFini` (function, line 15203) `FcFini();`
  ...
  - `RC_DEFER_BAND_RUNS` (macro, line 6317) `#define RC_DEFER_BAND_RUNS`
  - `BUI_CONIC_SLICES` (macro, line 8868) `#define BUI_CONIC_SLICES`
  - `OV_MAX_DEPTH` (macro, line 9565) `#define OV_MAX_DEPTH`
  - `H2R` (macro, line 10168) `#define H2R(p,q,t)`
  - `PDF_PAGE_W` (macro, line 10917) `#define PDF_PAGE_W`
  - `PDF_PAGE_H` (macro, line 10918) `#define PDF_PAGE_H`
  - `PDF_MARGIN` (macro, line 10919) `#define PDF_MARGIN`
  - `PNG_PAGE_W` (macro, line 11081) `#define PNG_PAGE_W`
  - `PNG_MARGIN` (macro, line 11094) `#define PNG_MARGIN`
  - `PNG_MAX_H` (macro, line 11095) `#define PNG_MAX_H`
  - `FBW_W` (macro, line 12848) `#define FBW_W`
  - `FBW_H` (macro, line 12850) `#define FBW_H`
  - `FBW_HEADER` (macro, line 12851) `#define FBW_HEADER`
  - `FBW_PAD` (macro, line 12852) `#define FBW_PAD`
  - `FBW_LINE` (macro, line 12853) `#define FBW_LINE`
  - `FBW_GUTTER` (macro, line 12854) `#define FBW_GUTTER`
  - `FBW_MIN_SPLIT` (macro, line 12855) `#define FBW_MIN_SPLIT`
  - `FBW_MAX_SPLIT` (macro, line 12856) `#define FBW_MAX_SPLIT`
  - `FBW_COPY_BTN_W` (macro, line 12857) `#define FBW_COPY_BTN_W`
  - `FBW_COPY_BTN_H` (macro, line 12858) `#define FBW_COPY_BTN_H`
