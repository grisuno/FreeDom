...
| `BUI_CONIC_SLICES` | macro | `gui/browser_ui.c:8840` | `#define BUI_CONIC_SLICES` |
| `FBW_COPY_BTN_H` | macro | `gui/browser_ui.c:12830` | `#define FBW_COPY_BTN_H` |
| `FBW_COPY_BTN_W` | macro | `gui/browser_ui.c:12829` | `#define FBW_COPY_BTN_W` |
| `FBW_GUTTER` | macro | `gui/browser_ui.c:12826` | `#define FBW_GUTTER` |
| `FBW_H` | macro | `gui/browser_ui.c:12822` | `#define FBW_H` |
| `FBW_HEADER` | macro | `gui/browser_ui.c:12823` | `#define FBW_HEADER` |
| `FBW_LINE` | macro | `gui/browser_ui.c:12825` | `#define FBW_LINE` |
| `FBW_MAX_SPLIT` | macro | `gui/browser_ui.c:12828` | `#define FBW_MAX_SPLIT` |
| `FBW_MIN_SPLIT` | macro | `gui/browser_ui.c:12827` | `#define FBW_MIN_SPLIT` |
| `FBW_PAD` | macro | `gui/browser_ui.c:12824` | `#define FBW_PAD` |
| `FBW_W` | macro | `gui/browser_ui.c:12820` | `#define FBW_W` |
...
| `FcFini` | function | `gui/browser_ui.c:15175` | `FcFini();` |
...
| `GET` | function | `gui/browser_ui.c:11743` | `* the network under weaker rules than a GET (Zero Trust). */
static void do_submit_post(browser_w...` |
| `H2R` | macro | `gui/browser_ui.c:10140` | `#define H2R(p,q,t)` |
...
| `OV_MAX_DEPTH` | macro | `gui/browser_ui.c:9537` | `#define OV_MAX_DEPTH` |
| `PDF_MARGIN` | macro | `gui/browser_ui.c:10891` | `#define PDF_MARGIN` |
| `PDF_PAGE_H` | macro | `gui/browser_ui.c:10890` | `#define PDF_PAGE_H` |
| `PDF_PAGE_W` | macro | `gui/browser_ui.c:10889` | `#define PDF_PAGE_W` |
| `PNG_MARGIN` | macro | `gui/browser_ui.c:11066` | `#define PNG_MARGIN` |
| `PNG_MAX_H` | macro | `gui/browser_ui.c:11067` | `#define PNG_MAX_H` |
| `PNG_PAGE_W` | macro | `gui/browser_ui.c:11053` | `#define PNG_PAGE_W` |
| `RC_BOX_STACK_MAX` | macro | `gui/browser_ui.c:3031` | `#define RC_BOX_STACK_MAX` |
| `RC_DEFER_BAND_RUNS` | macro | `gui/browser_ui.c:6312` | `#define RC_DEFER_BAND_RUNS` |
...
| `_exit` | function | `gui/browser_ui.c:8174` | `_exit(127);` |
...
| `again` | function | `gui/browser_ui.c:8232` | `* before a respawn opens it again (the WNOHANG reap left the old * process alive long enough to make the new one fail wi` |
| `allowlisted` | type_alias | `gui/browser_ui.c:1486` | `typedef struct fetch_prep { int allowlisted;` |
| `anchor` | function | `gui/browser_ui.c:7117` | `* anchor (spec/float.md §7d.3) exactly like a text block. An * empty/hidden one leaves cur_top untouched, so this is a n` |
| `applies` | function | `gui/browser_ui.c:14877` | `* persisted choice applies (prefs_parse already clamped it to a valid mode). */ const char *js_env = getenv("FREEDOM_JS"` |
| `apply_auth` | function | `gui/browser_ui.c:1391` | `apply_auth(w, abs, &cfg);` |
| `apply_click_result` | function | `gui/browser_ui.c:11637` | `static void apply_click_result(browser_window *w, tab_page *page)` |
 ...
 * and local ...` |
| `audio_mark_dead` | function | `gui/browser_ui.c:8191` | `static void audio_mark_dead(browser_window *w)` |
| `audio_spawn` | function | `gui/browser_ui.c:8136` | `static void audio_spawn(browser_window *w, int rate, int channels)` |
| `audio_stop` | function | `gui/browser_ui.c:8222` | `static void audio_stop(browser_window *w)` |
| `audio_write` | function | `gui/browser_ui.c:8208` | `static void audio_write(browser_window *w, const uint8_t *data, size_t len)` |
...
| `bg` | function | `gui/browser_ui.c:9406` | `* its own DISTINCT bg (an inline span highlight) still paints. */ int own_bid = row_owner_block_id(L, r);` |
...
| `block_style` | function | `gui/browser_ui.c:3410` | `static void block_style(const ui_theme *th, const rd_block *b,
                        double *si...` |
| `blocking` | function | `gui/browser_ui.c:8519` | `* are blocking (POLLIN guaranteed data is available). */ int flags = fcntl(out_fd, F_GETFL, 0);` |
...
| `box_forms_stacking_context` | function | `gui/browser_ui.c:9668` | `static int box_forms_stacking_context(const pv_box_def *def)` |
...
| `box_path` | function | `gui/browser_ui.c:8774` | `static void box_path(cairo_t *cr, double x, double y, double w, double h, double r)` |
| `box_path4` | function | `gui/browser_ui.c:8776` | `box_path4(cr, x, y, w, h, rc);` |
...
| `box_pointer_events_none` | function | `gui/browser_ui.c:11500` | `static int box_pointer_events_none(const rd_doc *doc, int block_id)` |
| `box_shrink_width` | function | `gui/browser_ui.c:6034` | `static double box_shrink_width(cairo_t *cr, const browser_window *w,
                            ...` |
| `box_transform_matrix` | function | `gui/browser_ui.c:9717` | `static void box_transform_matrix(const pv_box_def *def, double box_x, double box_y,
             ...` |
| `browser_add_exception` | function | `gui/browser_ui.c:14274` | `browser_add_exception(&w->bs, host);` |
...
| `browser_commit_url_bar` | function | `gui/browser_ui.c:13504` | `browser_commit_url_bar(&w->bs);` |
| `browser_free` | function | `gui/browser_ui.c:2430` | `browser_free(&w->bs);` |
| `browser_navigate` | function | `gui/browser_ui.c:14796` | `else browser_navigate(&w.bs, start_url);` |
...
| `browser_url_bar_backspace` | function | `gui/browser_ui.c:14515` | `browser_url_bar_backspace(&w->bs);` |
| `browser_url_bar_clear` | function | `gui/browser_ui.c:2506` | `browser_url_bar_clear(&w->bs);` |
| `browser_url_bar_delete` | function | `gui/browser_ui.c:14518` | `browser_url_bar_delete(&w->bs);` |
| `browser_url_bar_delete_selection` | function | `gui/browser_ui.c:14064` | `browser_url_bar_delete_selection(&w->bs);` |
| `browser_url_bar_insert` | function | `gui/browser_ui.c:13966` | `browser_url_bar_insert(&w->bs, (char)c);` |
| `browser_url_bar_move_cursor` | function | `gui/browser_ui.c:14522` | `else browser_url_bar_move_cursor(&w->bs, -1);` |
| `browser_url_bar_select_all` | function | `gui/browser_ui.c:14264` | `browser_url_bar_select_all(&w->bs);` |
| `browser_url_bar_set_cursor` | function | `gui/browser_ui.c:14527` | `browser_url_bar_set_cursor(&w->bs, 0, shift);` |
...
| `bui_blend_operator` | function | `gui/browser_ui.c:9836` | `static cairo_operator_t bui_blend_operator(int mix_blend)` |
| `bui_box_blur_surface` | function | `gui/browser_ui.c:10014` | `bui_box_blur_surface(snap, radius);` |
| `bui_grad_color_at` | function | `gui/browser_ui.c:8816` | `static ui_rgb bui_grad_color_at(const int *cols, const int *pos1000, int nst,
                   ...` |
| `bui_paint_backdrop_blur` | function | `gui/browser_ui.c:9974` | `static void bui_paint_backdrop_blur(cairo_t *cr, const pv_box_def *def,
                         ...` |
| `bui_paint_conic` | function | `gui/browser_ui.c:8998` | `bui_paint_conic(cr, x, y, w, h, rad, bx->grad_angle, bx->grad_c, bx->grad_pos, bx->grad_n);` |
| `bui_pop_group_composite` | function | `gui/browser_ui.c:10032` | `static void bui_pop_group_composite(cairo_t *cr, const pv_box_def *def, uint64_t elapsed_ms)` |
| `bui_skew_tan` | function | `gui/browser_ui.c:9711` | `static double bui_skew_tan(int deg)` |
...
| `button_box_width` | function | `gui/browser_ui.c:7520` | `static double button_box_width(cairo_t *cr, const ui_theme *th, const rd_block *b,
              ...` |
| `bx_content_clipped` | function | `gui/browser_ui.c:9543` | `return bx_content_clipped(d->overflow_x, d->overflow_y);` |
...
| `cairo_arc` | function | `gui/browser_ui.c:7569` | `cairo_arc(cr, bx + 7.0, by + 7.0, r, 0, 2 * M_PI);` |
| `cairo_clip` | function | `gui/browser_ui.c:7552` | `cairo_clip(cr);` |
| `cairo_clip_extents` | function | `gui/browser_ui.c:10052` | `cairo_clip_extents(cr, &x1, &y1, &x2, &y2);` |
| `cairo_close_path` | function | `gui/browser_ui.c:7652` | `cairo_close_path(cr);` |
| `cairo_curve_to` | function | `gui/browser_ui.c:9263` | `cairo_curve_to(cr, cx + half * 0.5, ly, cx + half * 0.5, cy, cx + half, cy);` |
| `cairo_debug_reset_static_data` | function | `gui/browser_ui.c:15174` | `cairo_debug_reset_static_data();` |
| `cairo_destroy` | function | `gui/browser_ui.c:10013` | `cairo_destroy(scr);` |
| `cairo_fill` | function | `gui/browser_ui.c:2692` | `cairo_fill(cr);` |
| `cairo_fill_preserve` | function | `gui/browser_ui.c:8670` | `cairo_fill_preserve(cr);` |
| `cairo_font_extents` | function | `gui/browser_ui.c:3773` | `cairo_font_extents(cr, &fe);` |
| `cairo_identity_matrix` | function | `gui/browser_ui.c:10021` | `cairo_identity_matrix(cr);` |
| `cairo_image_surface_create` | function | `gui/browser_ui.c:11122` | `cairo_image_surface_create(CAIRO_FORMAT_ARGB32, (int)PNG_PAGE_W, (int)img_h);` |
| `cairo_line_to` | function | `gui/browser_ui.c:7582` | `cairo_line_to(cr, bx + 6.5, by + 10.5);` |
| `cairo_mask_surface` | function | `gui/browser_ui.c:10193` | `cairo_mask_surface(scr, flt_surf, 0, 0);` |
| `cairo_matrix_init_identity` | function | `gui/browser_ui.c:9721` | `cairo_matrix_init_identity(m);` |
| `cairo_matrix_multiply` | function | `gui/browser_ui.c:9826` | `cairo_matrix_multiply(m, &k, m);` |
| `cairo_matrix_rotate` | function | `gui/browser_ui.c:9820` | `cairo_matrix_rotate(m, rot);` |
| `cairo_matrix_scale` | function | `gui/browser_ui.c:9821` | `cairo_matrix_scale(m, sx, sy);` |
| `cairo_matrix_translate` | function | `gui/browser_ui.c:9818` | `cairo_matrix_translate(m, tx, ty);` |
| `cairo_move_to` | function | `gui/browser_ui.c:2805` | `cairo_move_to(cr, dx, y);` |
| `cairo_new_sub_path` | function | `gui/browser_ui.c:8764` | `cairo_new_sub_path(cr);` |
| `cairo_paint` | function | `gui/browser_ui.c:7998` | `cairo_paint(cr);` |
| `cairo_paint_with_alpha` | function | `gui/browser_ui.c:10252` | `cairo_paint_with_alpha(cr, alpha);` |
| `cairo_pattern_add_color_stop_rgb` | function | `gui/browser_ui.c:9010` | `cairo_pattern_add_color_stop_rgb(pat, pos, sc.r, sc.g, sc.b);` |
| `cairo_pattern_add_color_stop_rgba` | function | `gui/browser_ui.c:8807` | `cairo_pattern_add_color_stop_rgba(pat, pos, sc.r, sc.g, sc.b, alpha);` |
| `cairo_pattern_destroy` | function | `gui/browser_ui.c:8919` | `cairo_pattern_destroy(ipat);` |
| `cairo_pattern_set_extend` | function | `gui/browser_ui.c:8914` | `cairo_pattern_set_extend(ipat, bx->bg_repeat == CSS_BGR_NO_REPEAT ? CAIRO_EXTEND_NONE : CAIRO_EXTEND_REPEAT);` |
| `cairo_pattern_set_filter` | function | `gui/browser_ui.c:7996` | `cairo_pattern_set_filter(cairo_get_source(cr), nearest ? CAIRO_FILTER_NEAREST : CAIRO_FILTER_GOOD);` |
| `cairo_pop_group_to_source` | function | `gui/browser_ui.c:10208` | `cairo_pop_group_to_source(cr);` |
| `cairo_push_group` | function | `gui/browser_ui.c:10348` | `cairo_push_group(cr);` |
| `cairo_rectangle` | function | `gui/browser_ui.c:2691` | `cairo_rectangle(cr, tx, ty, UI_SCROLLBAR_W, trh);` |
| `cairo_restore` | function | `gui/browser_ui.c:7556` | `cairo_restore(cr);` |
| `cairo_save` | function | `gui/browser_ui.c:7550` | `cairo_save(cr);` |
| `cairo_scale` | function | `gui/browser_ui.c:7958` | `cairo_scale(cr, dw / (double)im->nat_w, dh / (double)im->nat_h);` |
...
| `cairo_set_dash` | function | `gui/browser_ui.c:9085` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9088` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9127` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9130` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9187` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9190` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9282` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_dash` | function | `gui/browser_ui.c:9284` | `cairo_set_dash(cr, (double[])` |
| `cairo_set_fill_rule` | function | `gui/browser_ui.c:8978` | `cairo_set_fill_rule(cr, CAIRO_FILL_RULE_EVEN_ODD);` |
| `cairo_set_font_size` | function | `gui/browser_ui.c:3300` | `cairo_set_font_size(cr, size);` |
| `cairo_set_line_cap` | function | `gui/browser_ui.c:9087` | `cairo_set_line_cap(cr, CAIRO_LINE_CAP_ROUND);` |
| `cairo_set_line_width` | function | `gui/browser_ui.c:7566` | `cairo_set_line_width(cr, lw);` |
| `cairo_set_operator` | function | `gui/browser_ui.c:10251` | `cairo_set_operator(cr, bui_blend_operator(def ? def->mix_blend : CSS_MB_UNSET));` |
| `cairo_set_source` | function | `gui/browser_ui.c:8917` | `cairo_set_source(cr, ipat);` |
| `cairo_set_source_rgb` | function | `gui/browser_ui.c:3312` | `else cairo_set_source_rgb(cr, c.r, c.g, c.b);` |
| `cairo_set_source_rgba` | function | `gui/browser_ui.c:8962` | `cairo_set_source_rgba(cr, sc.r, sc.g, sc.b, 0.30 / (double)steps);` |
| `cairo_set_source_surface` | function | `gui/browser_ui.c:7993` | `cairo_set_source_surface(cr, im->surface, 0.0, 0.0);` |
| `cairo_show_page` | function | `gui/browser_ui.c:10999` | `cairo_show_page(cr);` |
| `cairo_show_text` | function | `gui/browser_ui.c:2806` | `cairo_show_text(cr, s);` |
| `cairo_stroke` | function | `gui/browser_ui.c:7570` | `cairo_stroke(cr);` |
...
| `cairo_transform` | function | `gui/browser_ui.c:10350` | `cairo_transform(cr, &m);` |
| `cairo_translate` | function | `gui/browser_ui.c:7952` | `cairo_translate(cr, left + pad + ax, ry + pad);` |
| `cairo_user_to_device` | function | `gui/browser_ui.c:9989` | `cairo_user_to_device(cr, &dx, &dy);` |
| `caller` | function | `gui/browser_ui.c:11230` | `* caller (freedom.c --download-pdf) owns the fetch/parse pipeline and supplies the
 * out_path ve...` |
| `chain` | function | `gui/browser_ui.c:7033` | `* chain (the box that left the normal flow at this pen position);` |
...
| `clipboard_copy` | function | `gui/browser_ui.c:14021` | `static void clipboard_copy(browser_window *w)` |
| `clipboard_cut` | function | `gui/browser_ui.c:14258` | `clipboard_cut(w);` |
| `clipboard_paste` | function | `gui/browser_ui.c:14248` | `clipboard_paste(w);` |
...
| `col` | type_alias | `gui/browser_ui.c:6248` | `typedef struct rc_defer { rc_defer_col col[RC_DEFER_COLS];` |
| `column` | function | `gui/browser_ui.c:5924` | `*
 * Returns the height of the tallest column (0 when there is nothing to fragment). */
static do...` |
| `compositing` | function | `gui/browser_ui.c:10452` | `* * Group compositing (M1.1 increments 3-4): a box that forms a CSS stacking context * (box_forms_stacking_context: opac` |
...
| `convention` | function | `gui/browser_ui.c:9150` | `* on the 3D bevel convention (light top/left, dark right/bottom). */ int is_3d = (style == CSS_BST_GROOVE \|\| style == ` |
| `cost` | function | `gui/browser_ui.c:15089` | `* measured cost (floor 33 ms = the existing ~30 fps ceiling):
...
| `css_replaced_box` | function | `gui/browser_ui.c:4064` | `static int css_replaced_box(const rd_doc *doc, const rd_block *b, double avail_w,
               ...` |
| `cursor_at_point` | function | `gui/browser_ui.c:11516` | `static int cursor_at_point(browser_window *w, double px, double py)` |
| `cx_forms_stacking_context` | function | `gui/browser_ui.c:9695` | `return cx_forms_stacking_context(&st);` |
| `data_device_data_offer` | function | `gui/browser_ui.c:13816` | `static void data_device_data_offer(void *data, struct wl_data_device *dev,
                      ...` |
| `data_device_drop` | function | `gui/browser_ui.c:13857` | `static void data_device_drop(void *d, struct wl_data_device *dev)` |
| `data_device_enter` | function | `gui/browser_ui.c:13847` | `static void data_device_enter(void *d, struct wl_data_device *dev, uint32_t serial,
             ...` |
| `data_device_leave` | function | `gui/browser_ui.c:13852` | `static void data_device_leave(void *d, struct wl_data_device *dev)` |
| `data_device_motion` | function | `gui/browser_ui.c:13853` | `static void data_device_motion(void *d, struct wl_data_device *dev, uint32_t t,
                 ...` |
| `data_device_selection` | function | `gui/browser_ui.c:13828` | `static void data_device_selection(void *data, struct wl_data_device *dev,
                       ...` |
| `data_offer_action` | function | `gui/browser_ui.c:13806` | `static void data_offer_action(void *d, struct wl_data_offer *o, uint32_t a)` |
| `data_offer_source_actions` | function | `gui/browser_ui.c:13803` | `static void data_offer_source_actions(void *d, struct wl_data_offer *o, uint32_t a)` |
| `data_source_cancelled` | function | `gui/browser_ui.c:13868` | `static void data_source_cancelled(void *data, struct wl_data_source *src)` |
| `data_source_send` | function | `gui/browser_ui.c:13874` | `static void data_source_send(void *data, struct wl_data_source *src,
                            ...` |
| `data_source_target` | function | `gui/browser_ui.c:13887` | `static void data_source_target(void *d, struct wl_data_source *s, const char *m)` |
| `deco_configure` | function | `gui/browser_ui.c:12742` | `static void deco_configure(void *data, struct zxdg_toplevel_decoration_v1 *d, uint32_t mode)` |
| `defer_append` | function | `gui/browser_ui.c:6391` | `static int defer_append(rc_defer *d, int key, int side,
                        int ml, int mlpct...` |
| `defer_flush` | function | `gui/browser_ui.c:6426` | `static void defer_flush(cairo_t *cr, const browser_window *w, rc_layout *L,
                     ...` |
| `defer_founder_style` | function | `gui/browser_ui.c:6378` | `defer_founder_style(doc, start, end, runs[r].key, &side, &ml, &mlpct, &mr, &mrpct);` |
| `defer_key_block` | function | `gui/browser_ui.c:6269` | `static int defer_key_block(const rd_block *bk)` |
| `delay` | function | `gui/browser_ui.c:356` | `* timer delay (tab_page.next_timer_ms);` |
| `deliver_fetch_result` | function | `gui/browser_ui.c:11856` | `static void deliver_fetch_result(browser_window *w, fetch_job *j)` |
| `descriptors` | function | `gui/browser_ui.c:8151` | `* descriptors (especially the Wayland display fd) so the sink does * not corrupt the Wayland protocol connection — the m` |
| `destroy_buffer` | function | `gui/browser_ui.c:588` | `static void destroy_buffer(browser_window *w)` |
| `dies` | function | `gui/browser_ui.c:8128` | `* child dies (exec failed, device busy, daemon absent) is detected on the
 * next PCM write (EPIP...` |
| `dispatch_click` | function | `gui/browser_ui.c:13734` | `dispatch_click(w, w->ptr_x, w->ptr_y);` |
| `dispatch_js_event` | function | `gui/browser_ui.c:14156` | `static void dispatch_js_event(browser_window *w, dom_node_id node_id,
                           ...` |
| `dispatch_mouse_event` | function | `gui/browser_ui.c:13409` | `dispatch_mouse_event(w, nid, "mouseenter", (int)w->ptr_x, (int)w->ptr_y, 0);` |
| `do_load` | function | `gui/browser_ui.c:1929` | `static void do_load(browser_window *w, const char *url);` |
| `do_submit_post` | function | `gui/browser_ui.c:11978` | `do_submit_post(w, &plan);` |
| `down` | function | `gui/browser_ui.c:13388` | `* defined further down (after dispatch_js_event) but called from ptr_enter/leave * /motion too. */ static void dispatch_` |
| `drain_fetch_results` | function | `gui/browser_ui.c:11911` | `static void drain_fetch_results(browser_window *w)` |
| `draw_clock` | function | `gui/browser_ui.c:12130` | `static void draw_clock(cairo_t *cr, ui_rgb color, double cx, double cy, double r,
               ...` |
| `draw_hamburger` | function | `gui/browser_ui.c:12141` | `static void draw_hamburger(cairo_t *cr, ui_rgb color, double bx, double ttop)` |
| `draw_hover_url` | function | `gui/browser_ui.c:12291` | `static double draw_hover_url(cairo_t *cr, browser_window *w)` |
| `draw_input_row` | function | `gui/browser_ui.c:9393` | `draw_input_row(cr, w, r->blk, left + r->x_off, cw, ry, r->ascent, r->height);` |
| `draw_menu` | function | `gui/browser_ui.c:12180` | `static void draw_menu(cairo_t *cr, browser_window *w)` |
| `draw_omnibox` | function | `gui/browser_ui.c:12408` | `static void draw_omnibox(cairo_t *cr, browser_window *w)` |
| `draw_reload` | function | `gui/browser_ui.c:12158` | `static void draw_reload(cairo_t *cr, ui_rgb color, double bx, double ttop)` |
...
| `draw_tabstrip` | function | `gui/browser_ui.c:12353` | `static void draw_tabstrip(cairo_t *cr, browser_window *w)` |
| `draw_text` | function | `gui/browser_ui.c:2799` | `static void draw_text(cairo_t *cr, const char *s, double x, double y, int centered)` |
| `draw_toast` | function | `gui/browser_ui.c:12323` | `static void draw_toast(cairo_t *cr, browser_window *w, double bottom_offset)` |
| `drop_repl_worker` | function | `gui/browser_ui.c:2000` | `static void drop_repl_worker(browser_window *w)` |
| `dup2` | function | `gui/browser_ui.c:8155` | `dup2(p[0], 0);` |
| `element` | function | `gui/browser_ui.c:12785` | `* cursor:pointer element (a JS-driven button/div, not just an <a>) shows the hand
 * even without...` |
...
| `ensure_download_dir` | function | `gui/browser_ui.c:11777` | `static int ensure_download_dir(char *out, size_t outsz)` |
| `execlp` | function | `gui/browser_ui.c:8171` | `else execlp("aplay", "aplay", "-r", rate_str, "-c", ch_str, "-f", "S16_LE", "-t", "raw", "-q", (char *)NULL);` |
| `export_pdf` | function | `gui/browser_ui.c:11010` | `static void export_pdf(browser_window *w)` |
| `export_png` | function | `gui/browser_ui.c:11195` | `static void export_png(browser_window *w)` |
...
| `fb_buffer_free` | function | `gui/browser_ui.c:11648` | `fb_buffer_free(&w->console);` |
| `fb_buffer_init` | function | `gui/browser_ui.c:2183` | `fb_buffer_init(&page.console);` |
| `fb_buffer_push` | function | `gui/browser_ui.c:13273` | `fb_buffer_push(&w->console, FB_ERROR, "Freebug: no live page to evaluate (reload the page first).", 56);` |
| `fb_buffer_push_loc` | function | `gui/browser_ui.c:13284` | `fb_buffer_push_loc(&w->console, e->level, e->text, e->len, e->file, e->line, e->col);` |
| `fb_buffer_reset` | function | `gui/browser_ui.c:2002` | `fb_buffer_reset(&w->console);` |
| `fbw_console_lines` | function | `gui/browser_ui.c:12902` | `static size_t fbw_console_lines(const fb_buffer *log)` |
| `fbw_level_rgb` | function | `gui/browser_ui.c:12891` | `static void fbw_level_rgb(int level, double *r, double *g, double *b)` |
| `fbw_split_y` | function | `gui/browser_ui.c:12855` | `static double fbw_split_y(const freebug_window *fb)` |
| `fbw_toplevel_close` | function | `gui/browser_ui.c:13160` | `static void fbw_toplevel_close(void *data, struct xdg_toplevel *t)` |
| `fbw_toplevel_configure` | function | `gui/browser_ui.c:13150` | `static void fbw_toplevel_configure(void *data, struct xdg_toplevel *t,
                          ...` |
| `fbw_xdg_surface_configure` | function | `gui/browser_ui.c:13142` | `static void fbw_xdg_surface_configure(void *data, struct xdg_surface *s, uint32_t serial)` |
| `fc_init` | function | `gui/browser_ui.c:14751` | `fc_init(&w.fc);` |
| `fc_set_active` | function | `gui/browser_ui.c:2163` | `fc_set_active(&w->fc, has_anim);` |
| `fclose` | function | `gui/browser_ui.c:635` | `fclose(f);` |
| `fcntl` | function | `gui/browser_ui.c:14772` | `fcntl(w.fetch_pipe[0], F_SETFL, O_NONBLOCK);` |
...
| `fill` | function | `gui/browser_ui.c:10360` | `* fill (paint_content_row's r->bg_rgb branch) cascades the SAME author * background-color as the box, but paints in the ` |
...
| `first` | function | `gui/browser_ui.c:7095` | `* flush first (no-op when nothing is deferred). */ defer_flush(cr, w, L, &s, th, content_w, doc, &df);` |
...
| `flex_item_min_main` | function | `gui/browser_ui.c:4760` | `static double flex_item_min_main(cairo_t *cr, const browser_window *w,
                          ...` |
| `flow` | function | `gui/browser_ui.c:15067` | `* flow (counting them starved aplay). A video frame read while * overdue overwrites the held slot (standard player frame` |
...
| `fprintf` | function | `gui/browser_ui.c:6385` | `fprintf(stderr, "[defer] band [%zu,%zu) keys=", start, end);` |
| `frag_styled` | function | `gui/browser_ui.c:3371` | `static int frag_styled(const rc_frag *f)` |
| `fragment` | function | `gui/browser_ui.c:9613` | `* first fragment (rc_frag.block_id, stamped at flow_emit_frag time) -- using
 * blk->block_id alo...` |
...
| `freebug_copy_console` | function | `gui/browser_ui.c:13899` | `static void freebug_copy_console(browser_window *w)` |
| `freebug_destroy` | function | `gui/browser_ui.c:13204` | `static void freebug_destroy(browser_window *w)` |
| `freebug_ensure_buffer` | function | `gui/browser_ui.c:12863` | `static int freebug_ensure_buffer(freebug_window *fb)` |
| `freebug_eval` | function | `gui/browser_ui.c:13259` | `static void freebug_eval(browser_window *w)` |
| `freebug_handle_key` | function | `gui/browser_ui.c:13299` | `static void freebug_handle_key(browser_window *w, xkb_keysym_t sym,
                             ...` |
| `freebug_hide` | function | `gui/browser_ui.c:13126` | `static void freebug_hide(browser_window *w)` |
| `freebug_is_open` | function | `gui/browser_ui.c:13215` | `static int freebug_is_open(const browser_window *w)` |
| `freebug_owns_surface` | function | `gui/browser_ui.c:13211` | `static int freebug_owns_surface(const browser_window *w, const struct wl_surface *sf)` |
| `freebug_paint` | function | `gui/browser_ui.c:12914` | `static void freebug_paint(freebug_window *fb)` |
| `freebug_pointer_axis` | function | `gui/browser_ui.c:13375` | `static void freebug_pointer_axis(browser_window *w, wl_fixed_t value)` |
| `freebug_pointer_button` | function | `gui/browser_ui.c:13334` | `static void freebug_pointer_button(browser_window *w, uint32_t serial,
                          ...` |
| `freebug_pointer_motion` | function | `gui/browser_ui.c:13353` | `static void freebug_pointer_motion(browser_window *w)` |
| `freebug_redraw` | function | `gui/browser_ui.c:13122` | `static void freebug_redraw(browser_window *w)` |
| `freebug_redraw_fb` | function | `gui/browser_ui.c:13113` | `static void freebug_redraw_fb(freebug_window *fb)` |
| `freebug_repl_worker` | function | `gui/browser_ui.c:13223` | `static tab *freebug_repl_worker(browser_window *w)` |
| `freebug_show` | function | `gui/browser_ui.c:13169` | `static void freebug_show(browser_window *w)` |
| `freebug_toggle` | function | `gui/browser_ui.c:13199` | `static void freebug_toggle(browser_window *w)` |
| `freebug_window` | type_alias | `gui/browser_ui.c:532` | `typedef struct freebug_window freebug_window;` |
| `freebug_window` | struct | `gui/browser_ui.c:12832` | `` |
...
| `go_omnibox` | function | `gui/browser_ui.c:13467` | `static void go_omnibox(browser_window *w)` |
...
| `handle_key_press` | function | `gui/browser_ui.c:14213` | `static void handle_key_press(browser_window *w, xkb_keysym_t sym, const char *utf8,
             ...` |
| `have` | function | `gui/browser_ui.c:7190` | `* as they always have (spec/float.md §6b.3). */ rc_float_clear(&s);` |
...
| `hls_playlist_free` | function | `gui/browser_ui.c:8274` | `hls_playlist_free(w->video_pl);` |
...
| `in` | function | `gui/browser_ui.c:11353` | `* a line landed in (Stage 3), which no other dump shows. Text stays out (it is * --dump-dom's job);` |
| `init_net_config` | function | `gui/browser_ui.c:979` | `static void init_net_config(browser_window *w)` |
| `input_box_width` | function | `gui/browser_ui.c:7511` | `static double input_box_width(double content_w)` |
...
| `insert_pasted_text` | function | `gui/browser_ui.c:13957` | `static void insert_pasted_text(browser_window *w, const char *text, size_t len)` |
| `ip_anim_init` | function | `gui/browser_ui.c:9747` | `ip_anim_init(&a, IP_VAL_SCALAR, &ease, prog_kf, 2, (double)def->anim_duration_ms, delay, iters, dir, fill);` |
| `ip_anim_tick` | function | `gui/browser_ui.c:9749` | `ip_anim_tick(&a, (double)elapsed_ms);` |
...
| `it` | function | `gui/browser_ui.c:7256` | `* column: flush first so the column lands above it (source order), * then move the anchor — the image bottom is the cont` |
...
| `key` | type_alias | `gui/browser_ui.c:6241` | `typedef struct rc_defer_col { int key;` |
| `key` | function | `gui/browser_ui.c:7176` | `* founders splits by key (stories, rail, footer nav each take * their column);` |
| `key_is_repeatable` | function | `gui/browser_ui.c:14543` | `static int key_is_repeatable(xkb_keysym_t sym, int n, int ctrl)` |
| `key_repeat_arm` | function | `gui/browser_ui.c:14559` | `static void key_repeat_arm(browser_window *w, uint32_t key)` |
| `key_repeat_fire` | function | `gui/browser_ui.c:14583` | `static void key_repeat_fire(browser_window *w)` |
| `key_repeat_stop` | function | `gui/browser_ui.c:14572` | `static void key_repeat_stop(browser_window *w)` |
| `key_sym_to_js_key` | function | `gui/browser_ui.c:14105` | `static const char *key_sym_to_js_key(xkb_keysym_t sym)` |
| `key_sym_to_keycode` | function | `gui/browser_ui.c:14131` | `static int key_sym_to_keycode(xkb_keysym_t sym)` |
| `keyboard_enter` | function | `gui/browser_ui.c:14089` | `static void keyboard_enter(void *d, struct wl_keyboard *kbd, uint32_t s,
                        ...` |
| `keyboard_key` | function | `gui/browser_ui.c:14596` | `static void keyboard_key(void *data, struct wl_keyboard *kbd, uint32_t serial,
                  ...` |
| `keyboard_keymap` | function | `gui/browser_ui.c:14068` | `static void keyboard_keymap(void *data, struct wl_keyboard *kbd,
                            uint...` |
| `keyboard_leave` | function | `gui/browser_ui.c:14097` | `static void keyboard_leave(void *d, struct wl_keyboard *kbd, uint32_t s, struct wl_surface *sf)` |
| `keyboard_modifiers` | function | `gui/browser_ui.c:14636` | `static void keyboard_modifiers(void *data, struct wl_keyboard *kbd, uint32_t s,
                 ...` |
| `keyboard_repeat_info` | function | `gui/browser_ui.c:14646` | `static void keyboard_repeat_info(void *d, struct wl_keyboard *kbd, int32_t rate, int32_t delay)` |
| `kill` | function | `gui/browser_ui.c:8197` | `kill(w->audio_pid, SIGKILL);` |
| `kind` | type_alias | `gui/browser_ui.c:2879` | `typedef struct rc_row { rc_rowkind kind;` |
| `layer` | function | `gui/browser_ui.c:9039` | `* first layer (CSS multi-background: the first declared URL is the topmost) * and OVER bg_rgb/gradient, UNDER the border` |
...
| `layout_container` | function | `gui/browser_ui.c:4876` | `static void layout_container(cairo_t *cr, const browser_window *w, rc_layout *L,
                ...` |
| `layout_doc` | function | `gui/browser_ui.c:6983` | `static void layout_doc(cairo_t *cr, const browser_window *w, double content_w,
                  ...` |
| `layout_float_band` | function | `gui/browser_ui.c:6646` | `static void layout_float_band(cairo_t *cr, const browser_window *w, rc_layout *L,
               ...` |
| `leave_inline_box` | function | `gui/browser_ui.c:6868` | `leave_inline_box(L, &si, bk->block_id);` |
| `limits` | function | `gui/browser_ui.c:10262` | `* documents narrower v1 limits (no overflow:hidden, no negative z-index). A box
 * grouped this w...` |
...
| `link_at_point` | function | `gui/browser_ui.c:11392` | `static const char *link_at_point(browser_window *w, double px, double py)` |
...
| `load_current` | function | `gui/browser_ui.c:13453` | `static void load_current(browser_window *w)` |
...
| `loop` | function | `gui/browser_ui.c:13948` | `* we return to the event loop (without this, the clipboard offer stays queued * and a paste that follows immediately mig` |
...
| `memory` | function | `gui/browser_ui.c:11660` | `* memory (the href pointer, not its contents, was all the old code preserved). */
static void dis...` |
| `memset` | function | `gui/browser_ui.c:980` | `memset(&w->net_cfg, 0, sizeof w->net_cfg);` |
| `menu_item_checked` | function | `gui/browser_ui.c:11998` | `static int menu_item_checked(const browser_window *w, size_t i)` |
| `menu_item_toggle` | function | `gui/browser_ui.c:12020` | `static void menu_item_toggle(browser_window *w, size_t i)` |
| `menu_panel_rect` | function | `gui/browser_ui.c:2774` | `static void menu_panel_rect(const browser_window *w, double *x, double *y,
                      ...` |
| `mime_is_text` | function | `gui/browser_ui.c:13785` | `static int mime_is_text(const char *mime)` |
...
| `munmap` | function | `gui/browser_ui.c:14085` | `munmap(map_str, size);` |
...
| `node_at_point` | function | `gui/browser_ui.c:11568` | `static dom_node_id node_at_point(browser_window *w, double px, double py)` |
...
| `origin` | function | `gui/browser_ui.c:11275` | `* top_url is the page origin (https or file://);` |
| `ov_box_bounds` | function | `gui/browser_ui.c:9569` | `static int ov_box_bounds(const rc_layout *L, int bid, rc_box *out)` |
| `ov_box_clips` | function | `gui/browser_ui.c:9541` | `static int ov_box_clips(const pv_box_def *d)` |
| `ov_collect_chain` | function | `gui/browser_ui.c:9548` | `static int ov_collect_chain(const rd_doc *doc, int block_id, int *out, int cap)` |
| `ov_content_rect` | function | `gui/browser_ui.c:9593` | `static void ov_content_rect(const rc_box *bx, const pv_box_def *d,
                            do...` |
| `ov_reconcile` | function | `gui/browser_ui.c:10426` | `ov_reconcile(cr, ov_stack, &ov_depth, w->doc, bx->block_id, L, origin, left);` |
...
| `paint` | function | `gui/browser_ui.c:12441` | `static void paint(browser_window *w)` |
| `paint_bg_layer` | function | `gui/browser_ui.c:8879` | `static void paint_bg_layer(cairo_t *cr, const rc_box *bx, const ui_bg_image *img,
               ...` |
| `paint_box_and_direct_rows` | function | `gui/browser_ui.c:10371` | `static void paint_box_and_direct_rows(cairo_t *cr, browser_window *w, const rc_layout *L,
       ...` |
| `paint_box_decoration` | function | `gui/browser_ui.c:8922` | `static void paint_box_decoration(cairo_t *cr, const rc_box *bx, double ox, double oy,
           ...` |
| `paint_box_decoration_grouped` | function | `gui/browser_ui.c:10330` | `static void paint_box_decoration_grouped(cairo_t *cr, browser_window *w,
                        ...` |
| `paint_content_row` | function | `gui/browser_ui.c:9352` | `static void paint_content_row(cairo_t *cr, browser_window *w, const rc_layout *L,
               ...` |
| `paint_deco_line` | function | `gui/browser_ui.c:9248` | `static void paint_deco_line(cairo_t *cr, double x0, double x1, double ly,
                       ...` |
| `paint_image_row` | function | `gui/browser_ui.c:9347` | `paint_image_row(cr, w, blk, x - th->image_box_pad, y - th->image_box_pad, f->repl_w + 2.0 * th->image_box_pad, f->repl_h` |
| `paint_inline_replaced` | function | `gui/browser_ui.c:9333` | `static void paint_inline_replaced(cairo_t *cr, browser_window *w,
                               ...` |
| `paint_nested_children` | function | `gui/browser_ui.c:10655` | `static void paint_nested_children(cairo_t *cr, browser_window *w,
                               ...` |
| `paint_positioned_one` | function | `gui/browser_ui.c:10466` | `static void paint_positioned_one(cairo_t *cr, browser_window *w, const ui_theme *th,
            ...` |
| `paint_structured` | function | `gui/browser_ui.c:10687` | `static void paint_structured(cairo_t *cr, browser_window *w, double content_top,
                ...` |
| `paint_svg_at` | function | `gui/browser_ui.c:9304` | `static void paint_svg_at(cairo_t *cr, const rd_block *blk, int cur,
                         doub...` |
| `paint_video_row` | function | `gui/browser_ui.c:8593` | `static void paint_video_row(cairo_t *cr, browser_window *w, const rd_block *blk,
                ...` |
...
| `place_inline_replaced` | function | `gui/browser_ui.c:4009` | `static int place_inline_replaced(rc_layout *L, rc_state *s, const ui_theme *th,
                 ...` |
| `poll` | function | `gui/browser_ui.c:8109` | `poll(&pfd, 1, 10);` |
| `position_doc` | function | `gui/browser_ui.c:7353` | `static void position_doc(cairo_t *cr, const browser_window *w, double content_w,
                ...` |
| `prefs_free` | function | `gui/browser_ui.c:15165` | `prefs_free(&w.prefs);` |
| `prefs_init` | function | `gui/browser_ui.c:14729` | `prefs_init(&w.prefs);` |
| `prepare_fetch` | function | `gui/browser_ui.c:1495` | `static int prepare_fetch(browser_window *w, const char *url, sf_config *cfg,
                    ...` |
| `presentation` | function | `gui/browser_ui.c:12018` | `* affect presentation (a repaint, which re-runs layout, suffices);` |
| `printf` | function | `gui/browser_ui.c:11348` | `printf("=== Freedom layout ===\n");` |
...
| `profile_close` | function | `gui/browser_ui.c:15166` | `profile_close(&w.profile);` |
...
| `pthread_join` | function | `gui/browser_ui.c:8257` | `pthread_join(w->video_thread, NULL);` |
| `pthread_mutex_destroy` | function | `gui/browser_ui.c:15144` | `pthread_mutex_destroy(&w.stream_lock);` |
| `pthread_mutex_init` | function | `gui/browser_ui.c:14778` | `pthread_mutex_init(&w.stream_lock, NULL);` |
...
| `ptr_axis` | function | `gui/browser_ui.c:13744` | `static void ptr_axis(void *data, struct wl_pointer *p, uint32_t time,
                     uint32...` |
| `ptr_button` | function | `gui/browser_ui.c:13511` | `static void ptr_button(void *d, struct wl_pointer *p, uint32_t serial, uint32_t t,
              ...` |
| `ptr_enter` | function | `gui/browser_ui.c:13393` | `static void ptr_enter(void *d, struct wl_pointer *p, uint32_t s,
                      struct wl_...` |
| `ptr_frame` | function | `gui/browser_ui.c:13768` | `static void ptr_frame(void *d, struct wl_pointer *p)` |
| `ptr_leave` | function | `gui/browser_ui.c:13412` | `static void ptr_leave(void *d, struct wl_pointer *p, uint32_t s, struct wl_surface *sf)` |
| `ptr_motion` | function | `gui/browser_ui.c:13429` | `static void ptr_motion(void *d, struct wl_pointer *p, uint32_t t, wl_fixed_t x, wl_fixed_t y)` |
...
| `rc_defer` | struct | `gui/browser_ui.c:6248` | `` |
| `rc_defer_col` | struct | `gui/browser_ui.c:6241` | `` |
...
| `rd_build` | function | `gui/browser_ui.c:7915` | `* rd_build (-1 = auto/off -> theme caret). */ if (b->caret_color >= 0 && !w->force_theme) set_rgb(cr, rgb_from_packed(b-` |
| `rd_input_label` | function | `gui/browser_ui.c:7524` | `: rd_input_label(b->input_type);` |
...
| `reconcile_boxes_below` | function | `gui/browser_ui.c:6042` | `static void reconcile_boxes_below(cairo_t *cr, const browser_window *w,
                         ...` |
| `rect` | function | `gui/browser_ui.c:8787` | `* across rect (x,y,w,h): the gradient line runs through the rect center, long * enough that the first/last stops land on` |
| `redraw` | function | `gui/browser_ui.c:12685` | `static void redraw(browser_window *w)` |
| `redraws` | function | `gui/browser_ui.c:14807` | `* so a large page with frequent redraws (spinner, JS ticks, video frames) * never hits "Data too big for buffer". A 4 Ki` |
| `reference` | function | `gui/browser_ui.c:11616` | `* reference (downgrade, foreign scheme, no resolvable base) navigates nowhere:
 * hostile content...` |
| `registry_global` | function | `gui/browser_ui.c:14682` | `static void registry_global(void *data, struct wl_registry *reg, uint32_t name,
                 ...` |
| `registry_remove` | function | `gui/browser_ui.c:14703` | `static void registry_remove(void *d, struct wl_registry *r, uint32_t name)` |
...
| `render_doc_images` | function | `gui/browser_ui.c:11279` | `static ui_status render_doc_images(const rd_doc *doc, tab *t, const char *top_url,
              ...` |
| `replaced_current_color` | function | `gui/browser_ui.c:9324` | `static int replaced_current_color(const browser_window *w, const rd_block *blk)` |
...
| `resizes` | function | `gui/browser_ui.c:12720` | `* when the window resizes (a no-op for the other modes). */ if (w->reader) apply_theme(w);` |
...
| `resolve_box_cursor` | function | `gui/browser_ui.c:11486` | `static int resolve_box_cursor(const rd_doc *doc, int block_id)` |
| `rewind` | function | `gui/browser_ui.c:631` | `rewind(f);` |
| `rgb_from_packed` | function | `gui/browser_ui.c:8838` | `return rgb_from_packed(cols[nst - 1] >= 0 ? cols[nst - 1] : 0);` |
...
static d...` |
| `row_align_offset` | function | `gui/browser_ui.c:8718` | `static double row_align_offset(const rc_layout *L, const rc_row *r, double content_w)` |
| `row_line_slack` | function | `gui/browser_ui.c:8706` | `static double row_line_slack(const rc_layout *L, const rc_row *r, double content_w)` |
| `row_owner_block_id` | function | `gui/browser_ui.c:9299` | `static int row_owner_block_id(const rc_layout *L, const rc_row *r);` |
| `rows` | function | `gui/browser_ui.c:9612` | `* RC_IMAGE rows (see its declaration);` |
| `run` | function | `gui/browser_ui.c:3503` | `* continuation run (block_id < 0 with no block break) deliberately skips reconcile
 * to stay on ...` |
| `save_current_page` | function | `gui/browser_ui.c:11847` | `static void save_current_page(browser_window *w)` |
| `save_download` | function | `gui/browser_ui.c:11814` | `static void save_download(browser_window *w, const char *url, const char *bytes,
                ...` |
| `saving` | function | `gui/browser_ui.c:14728` | `* disables saving (never clobber);` |
| `schedule_js_tick` | function | `gui/browser_ui.c:2014` | `static void schedule_js_tick(browser_window *w, int next_ms)` |
| `scroll_line_px` | function | `gui/browser_ui.c:13741` | `static double scroll_line_px(const browser_window *w)` |
...
| `scrollbar_metrics` | function | `gui/browser_ui.c:2640` | `static int scrollbar_metrics(const browser_window *w, double *track_x, double *track_y,
         ...` |
| `seat_caps` | function | `gui/browser_ui.c:14664` | `static void seat_caps(void *data, struct wl_seat *seat, uint32_t caps)` |
| `seat_name` | function | `gui/browser_ui.c:14676` | `static void seat_name(void *d, struct wl_seat *s, const char *name)` |
...
| `select_box_width` | function | `gui/browser_ui.c:7514` | `static double select_box_width(double content_w)` |
| `set_cache` | function | `gui/browser_ui.c:1212` | `static void set_cache(browser_window *w, char *html, size_t len, const char *top)` |
| `set_cursor` | function | `gui/browser_ui.c:12755` | `static void set_cursor(browser_window *w, int cur_kind)` |
| `set_rgb` | function | `gui/browser_ui.c:9164` | `set_rgb(cr, (ui_rgb)` |
...
| `sf_global_init` | function | `gui/browser_ui.c:14769` | `sf_global_init();` |
...
| `show_fetch_error` | function | `gui/browser_ui.c:2212` | `static void show_fetch_error(browser_window *w, const char *url, sf_status ss,
                  ...` |
| `signal` | function | `gui/browser_ui.c:8548` | `signal(SIGPIPE, SIG_IGN);` |
...
| `spaced` | function | `gui/browser_ui.c:8847` | `* or evenly spaced (bui_grad_color_at). */
static void bui_paint_conic(cairo_t *cr, double x, dou...` |
| `standalone` | function | `gui/browser_ui.c:7208` | `* must not be treated as standalone (which would flush that line and give * the element a row of its own -- R7). */ int ` |
...
| `submit_form` | function | `gui/browser_ui.c:13716` | `submit_form(w, ctl);` |
...
| `tab_eval_result_free` | function | `gui/browser_ui.c:13292` | `tab_eval_result_free(&r);` |
...
| `table` | function | `gui/browser_ui.c:4515` | `* synthesised table (no descriptors to disagree) keeps the stamp. */
        if (cd != NULL && !c...` |
| `text` | function | `gui/browser_ui.c:8791` | `* fill and gradient text (2026-07-19). */
static cairo_pattern_t *bui_linear_grad(double x, doubl...` |
| `tf_backspace` | function | `gui/browser_ui.c:14397` | `tf_backspace(&w->ua_field);` |
| `tf_clear` | function | `gui/browser_ui.c:13295` | `tf_clear(&fb->editor);` |
| `tf_delete` | function | `gui/browser_ui.c:14399` | `tf_delete(&w->ua_field);` |
| `tf_end` | function | `gui/browser_ui.c:14407` | `tf_end(&w->ua_field);` |
| `tf_home` | function | `gui/browser_ui.c:14405` | `tf_home(&w->ua_field);` |
| `tf_init` | function | `gui/browser_ui.c:1187` | `tf_init(&st->field);` |
| `tf_insert` | function | `gui/browser_ui.c:13314` | `tf_insert(&fb->editor, '\n');` |
| `tf_move` | function | `gui/browser_ui.c:14401` | `tf_move(&w->ua_field, -1);` |
| `tf_set` | function | `gui/browser_ui.c:14182` | `tf_set(&w->inputs[i].field, value);` |
| `the` | function | `gui/browser_ui.c:10184` | `* the (already filtered) group with the shadow color, blur it, and * paint it under the group at the declared offset -- ` |
| `thumbnail` | function | `gui/browser_ui.c:6728` | `* is what made a wikipedia thumbnail (a 250px image and its caption, no
     * declared width) sp...` |
| `timerfd_settime` | function | `gui/browser_ui.c:14568` | `timerfd_settime(w->repeat_timer_fd, 0, &its, NULL);` |
...
| `toggle_reader` | function | `gui/browser_ui.c:11987` | `static void toggle_reader(browser_window *w)` |
...
| `toplevel_close` | function | `gui/browser_ui.c:12734` | `static void toplevel_close(void *data, struct xdg_toplevel *t)` |
| `toplevel_configure` | function | `gui/browser_ui.c:12711` | `static void toplevel_configure(void *data, struct xdg_toplevel *t,
                              ...` |
| `treatment` | function | `gui/browser_ui.c:6088` | `* block treatment (shrink-wrapped and placed by text-align), which is what a
         * standalon...` |
| `tsh_shutdown` | function | `gui/browser_ui.c:15173` | `tsh_shutdown();` |
...
| `ui_dump_layout` | function | `gui/browser_ui.c:11331` | `ui_status ui_dump_layout(const rd_doc *doc)` |
| `ui_hot` | enum | `gui/browser_ui.c:205` | `` |
| `ui_image` | struct | `gui/browser_ui.c:236` | `` |
| `ui_input_state` | struct | `gui/browser_ui.c:212` | `` |
| `ui_layout_free` | function | `gui/browser_ui.c:12669` | `ui_layout_free(&lay);` |
| `ui_menu_action` | enum | `gui/browser_ui.c:157` | `` |
| `ui_menu_item` | struct | `gui/browser_ui.c:174` | `` |
| `ui_render_pdf_images` | function | `gui/browser_ui.c:11315` | `ui_status ui_render_pdf_images(const rd_doc *doc, tab *t, const char *top_url,
                  ...` |
| `ui_render_png` | function | `gui/browser_ui.c:11253` | `ui_status ui_render_png(const rd_doc *doc, const char *out_path, long *out_h)` |
| `ui_render_png_images` | function | `gui/browser_ui.c:11309` | `ui_status ui_render_png_images(const rd_doc *doc, tab *t, const char *top_url,
                  ...` |
| `ui_run_browser` | function | `gui/browser_ui.c:14712` | `ui_status ui_run_browser(const char *start_url)` |
| `uitab_close` | function | `gui/browser_ui.c:2511` | `static void uitab_close(browser_window *w, int idx)` |
| `unlink` | function | `gui/browser_ui.c:11807` | `unlink(tmp);` |
| `update_hover` | function | `gui/browser_ui.c:13404` | `update_hover(w);` |
| `upstream` | function | `gui/browser_ui.c:8746` | `* upstream (see spec/css.md). */
...
| `v_read` | function | `gui/browser_ui.c:8100` | `static int v_read(int fd, void *buf, size_t n)` |
| `v_write` | function | `gui/browser_ui.c:8573` | `v_write(w->decoder_cmd_fd, &cmd, 1);` |
| `video_feeder_thread` | function | `gui/browser_ui.c:1029` | `static void *video_feeder_thread(void *arg);` |
| `video_fetch` | function | `gui/browser_ui.c:8421` | `static sf_status video_fetch(const char *url, browser_window *w,
                              sf...` |
| `video_play` | function | `gui/browser_ui.c:8438` | `static int video_play(browser_window *w, const char *m3u8_url)` |
| `video_stop` | function | `gui/browser_ui.c:8242` | `static void video_stop(browser_window *w)` |
| `video_stop` | function | `gui/browser_ui.c:8540` | `* each segment loop so a video_stop() in the main thread (which sets it to 0
 * then calls pthrea...` |
| `waitpid` | function | `gui/browser_ui.c:8198` | `waitpid(w->audio_pid, NULL, 0);` |
...
| `wl_array_for_each` | function | `gui/browser_ui.c:12728` | `wl_array_for_each(st, states)` |
| `wl_buffer_add_listener` | function | `gui/browser_ui.c:614` | `wl_buffer_add_listener(w->buffer, &buffer_listener, w);` |
| `wl_data_device_add_listener` | function | `gui/browser_ui.c:14831` | `wl_data_device_add_listener(w.data_device, &data_device_listener, &w);` |
| `wl_data_device_set_selection` | function | `gui/browser_ui.c:13946` | `wl_data_device_set_selection(w->data_device, w->copy_source, w->last_serial);` |
| `wl_data_offer_add_listener` | function | `gui/browser_ui.c:13823` | `wl_data_offer_add_listener(offer, &data_offer_listener, w);` |
| `wl_data_offer_receive` | function | `gui/browser_ui.c:13987` | `wl_data_offer_receive(w->selection_offer, mime, fds[1]);` |
| `wl_data_source_add_listener` | function | `gui/browser_ui.c:13943` | `wl_data_source_add_listener(w->copy_source, &data_source_listener, w);` |
| `wl_data_source_destroy` | function | `gui/browser_ui.c:13871` | `wl_data_source_destroy(src);` |
| `wl_data_source_offer` | function | `gui/browser_ui.c:13945` | `wl_data_source_offer(w->copy_source, "text/plain");` |
| `wl_display_cancel_read` | function | `gui/browser_ui.c:14989` | `wl_display_cancel_read(w.display);` |
| `wl_display_disconnect` | function | `gui/browser_ui.c:14821` | `wl_display_disconnect(w.display);` |
| `wl_display_dispatch_pending` | function | `gui/browser_ui.c:14920` | `wl_display_dispatch_pending(w.display);` |
| `wl_display_flush` | function | `gui/browser_ui.c:12693` | `wl_display_flush(w->display);` |
| `wl_display_roundtrip` | function | `gui/browser_ui.c:13990` | `wl_display_roundtrip(w->display);` |
| `wl_keyboard_add_listener` | function | `gui/browser_ui.c:14673` | `wl_keyboard_add_listener(w->keyboard, &keyboard_listener, w);` |
| `wl_pointer_add_listener` | function | `gui/browser_ui.c:14669` | `wl_pointer_add_listener(w->pointer, &pointer_listener, w);` |
| `wl_pointer_set_cursor` | function | `gui/browser_ui.c:12775` | `wl_pointer_set_cursor(w->pointer, w->pointer_serial, w->cursor_surface, (int32_t)img->hotspot_x, (int32_t)img->hotspot_y` |
| `wl_registry_add_listener` | function | `gui/browser_ui.c:14817` | `wl_registry_add_listener(w.registry, &registry_listener, &w);` |
| `wl_seat_add_listener` | function | `gui/browser_ui.c:14696` | `wl_seat_add_listener(w->seat, &seat_listener, w);` |
| `wl_shm_pool_destroy` | function | `gui/browser_ui.c:611` | `wl_shm_pool_destroy(pool);` |
| `wl_surface_attach` | function | `gui/browser_ui.c:12690` | `wl_surface_attach(w->surface, w->buffer, 0, 0);` |
| `wl_surface_commit` | function | `gui/browser_ui.c:12692` | `wl_surface_commit(w->surface);` |
| `wl_surface_damage` | function | `gui/browser_ui.c:12778` | `wl_surface_damage(w->cursor_surface, 0, 0, (int32_t)img->width, (int32_t)img->height);` |
| `wl_surface_damage_buffer` | function | `gui/browser_ui.c:12691` | `wl_surface_damage_buffer(w->surface, 0, 0, w->width, w->height);` |
| `wm_base_ping` | function | `gui/browser_ui.c:12697` | `static void wm_base_ping(void *data, struct xdg_wm_base *b, uint32_t serial)` |
| `write_doc_pdf` | function | `gui/browser_ui.c:10905` | `static long write_doc_pdf(browser_window *w, const char *path)` |
| `write_doc_png` | function | `gui/browser_ui.c:11074` | `static long write_doc_png(browser_window *w, const char *path)` |
| `write_file_atomic` | function | `gui/browser_ui.c:11792` | `static int write_file_atomic(const char *path, const void *bytes, size_t len)` |
| `x` | function | `gui/browser_ui.c:6479` | `* reported x is already the BORDER x (the §7c.2 rule);` |
| `xdg_surface_ack_configure` | function | `gui/browser_ui.c:12706` | `xdg_surface_ack_configure(s, serial);` |
| `xdg_surface_add_listener` | function | `gui/browser_ui.c:13186` | `xdg_surface_add_listener(fb->xdg_surface, &fbw_xdg_surface_listener, fb);` |
| `xdg_surface_configure` | function | `gui/browser_ui.c:12703` | `static void xdg_surface_configure(void *data, struct xdg_surface *s, uint32_t serial)` |
| `xdg_toplevel_add_listener` | function | `gui/browser_ui.c:13188` | `xdg_toplevel_add_listener(fb->xdg_toplevel, &fbw_toplevel_listener, fb);` |
| `xdg_toplevel_move` | function | `gui/browser_ui.c:13637` | `xdg_toplevel_move(w->xdg_toplevel, w->seat, serial);` |
| `xdg_toplevel_set_app_id` | function | `gui/browser_ui.c:13190` | `xdg_toplevel_set_app_id(fb->xdg_toplevel, "org.freedom.freebug");` |
| `xdg_toplevel_set_fullscreen` | function | `gui/browser_ui.c:1039` | `xdg_toplevel_set_fullscreen(w->xdg_toplevel, NULL);` |
| `xdg_toplevel_set_maximized` | function | `gui/browser_ui.c:13633` | `else xdg_toplevel_set_maximized(w->xdg_toplevel);` |
| `xdg_toplevel_set_minimized` | function | `gui/browser_ui.c:13635` | `xdg_toplevel_set_minimized(w->xdg_toplevel);` |
| `xdg_toplevel_set_title` | function | `gui/browser_ui.c:13189` | `xdg_toplevel_set_title(fb->xdg_toplevel, "Freebug - Freedom DevTools");` |
| `xdg_toplevel_unset_fullscreen` | function | `gui/browser_ui.c:1037` | `xdg_toplevel_unset_fullscreen(w->xdg_toplevel);` |
| `xdg_wm_base_add_listener` | function | `gui/browser_ui.c:14693` | `xdg_wm_base_add_listener(w->wm_base, &wm_base_listener, w);` |
| `xdg_wm_base_pong` | function | `gui/browser_ui.c:12700` | `xdg_wm_base_pong(b, serial);` |
| `xkb_context_unref` | function | `gui/browser_ui.c:14823` | `xkb_context_unref(w.xkb_ctx);` |
| `xkb_state_update_mask` | function | `gui/browser_ui.c:14643` | `xkb_state_update_mask(w->xkb_state, mods_depressed, mods_latched, mods_locked, 0, 0, group);` |
| `zxdg_toplevel_decoration_v1_add_listener` | function | `gui/browser_ui.c:14845` | `zxdg_toplevel_decoration_v1_add_listener(w.deco, &deco_listener, &w);` |
| `zxdg_toplevel_decoration_v1_set_mode` | function | `gui/browser_ui.c:13193` | `zxdg_toplevel_decoration_v1_set_mode(fb->deco, ZXDG_TOPLEVEL_DECORATION_V1_MODE_SERVER_SIDE);` |
...
| `CSS_MEDIA_MAX_DEPTH` | macro | `src/css.c:5462` | `#define CSS_MEDIA_MAX_DEPTH` |
| `CSS_MEDIA_TOK` | macro | `src/css.c:5331` | `#define CSS_MEDIA_TOK` |
...
| `NULL` | function | `src/css.c:6636` | `* Sheet can be NULL (inline style, no @keyframes). */
...
| `add_rule` | function | `src/css.c:5219` | `static void add_rule(css_sheet *sh, const char *s, size_t ss, size_t se,
                     siz...` |
| `apply_decl` | function | `src/css.c:6029` | `static void apply_decl(css_style *o, int *wi, int *ws, int *wo, int *wem, int *wv,
              ...` |
| `at_is_media` | function | `src/css.c:5454` | `static int at_is_media(const char *s, size_t i, size_t n)` |
| `bg_alpha_of` | function | `src/css.c:401` | `static int bg_alpha_of(const char *v)` |
| `block_end` | function | `src/css.c:5320` | `static size_t block_end(const char *s, size_t open, size_t n)` |
...
| `caller` | function | `src/css.c:4479` | `* left to the caller (parse_one_decl stamps it). */ /* `known` (optional) reports whether the property NAME reached a br` |
| `cl_ctx_initial` | function | `src/css.c:965` | `return cl_ctx_initial();` |
| `cl_number` | function | `src/css.c:340` | `return cl_number(s, out, endp);` |
| `collect_custom_decls` | function | `src/css.c:5518` | `collect_custom_decls(s, ds, de, tab, cap, ntab);` |
| `collect_custom_props_scoped` | function | `src/css.c:5472` | `static void collect_custom_props_scoped(const char *s, size_t start, size_t end,
                ...` |
| `column` | function | `src/css.c:3622` | `* column (`flex: 1 1 0%`);` |
| `computed_font_size` | function | `src/css.c:6382` | `static double computed_font_size(const css_style *o, const css_element *el)` |
...
| `copy_lower_trim` | function | `src/css.c:5365` | `static size_t copy_lower_trim(const char *s, size_t a, size_t b, char *dst, size_t cap)` |
| `copy_trim` | function | `src/css.c:3762` | `static size_t copy_trim(const char *s, size_t a, size_t b, char *dst, size_t cap)` |
...
| `css_computed_font_size` | function | `src/css.c:6384` | `return css_computed_font_size(o, (el != NULL) ? el->font_size : 0.0);` |
| `css_custom_prop` | struct | `src/css.c:272` | `` |
| `css_decl` | struct | `src/css.c:234` | `` |
| `css_font_face_at` | function | `src/css.c:6671` | `int css_font_face_at(const css_sheet *sheet, size_t i,
                     char *family, size_t ...` |
| `css_font_face_count` | function | `src/css.c:6667` | `size_t css_font_face_count(const css_sheet *sheet)` |
| `css_free` | function | `src/css.c:6015` | `void css_free(css_sheet *s)` |
| `css_keyframe_stop` | struct | `src/css.c:304` | `` |
| `css_parse` | function | `src/css.c:5931` | `css_status css_parse(const char *text, size_t len, css_sheet **out)` |
| `css_parse_inline` | function | `src/css.c:6681` | `css_style css_parse_inline(const char *style, size_t len)` |
| `css_parse_logged` | function | `src/css.c:5945` | `css_status css_parse_logged(const char *text, size_t len, const css_media *media,
               ...` |
| `css_parse_media` | function | `src/css.c:5935` | `css_status css_parse_media(const char *text, size_t len, const css_media *media,
                ...` |
| `css_parse_scoped` | function | `src/css.c:5940` | `css_status css_parse_scoped(const char *text, size_t len, const css_media *media,
               ...` |
| `css_resolve` | function | `src/css.c:6611` | `css_style css_resolve(const css_sheet *sheet, const char *tag, const char *id,
                  ...` |
| `css_resolve_anim_keyframes` | function | `src/css.c:6607` | `css_resolve_anim_keyframes(&out, sheet);` |
| `css_resolve_el` | function | `src/css.c:6431` | `css_style css_resolve_el(const css_sheet *sheet, const css_element *el,
                         ...` |
| `css_rule` | struct | `src/css.c:280` | `` |
| `css_sheet` | struct | `src/css.c:282` | `` |
| `declaration` | function | `src/css.c:870` | `* declaration (fail closed);` |
| `declared` | function | `src/css.c:5173` | `* the referenced custom property was never declared (or the fallback * chain bottomed out), so the declaration is invali` |
| `downstream` | function | `src/css.c:811` | `* happens downstream (render_doc.c), gated by caps.images like an <img>. */
static int expand_bg_...` |
| `drop_copy_text` | function | `src/css.c:5104` | `static void drop_copy_text(char *dst, size_t cap, const char *src)` |
| `drop_record` | function | `src/css.c:5123` | `static void drop_record(css_drop_log *log, const char *prop, const char *val, int cause)` |
...
| `expand_gap` | function | `src/css.c:4323` | `static int expand_gap(const char *val, css_decl *dst, int cap)` |
...
| `expand_transform_origin` | function | `src/css.c:4291` | `static int expand_transform_origin(const char *val, css_decl *dst, int cap)` |
...
| `find_radial_gradient` | function | `src/css.c:766` | `static int find_radial_gradient(const char *v, size_t *start, size_t *end,
                      ...` |
| `fold_font_relative` | function | `src/css.c:6403` | `static void fold_font_relative(css_style *o, int *wi, int *ws, int *wo,
                         ...` |
| `free` | function | `src/css.c:6007` | `free(rebased);` |
| `function` | function | `src/css.c:4062` | `* function (perspective/3D), multiple space-separated functions, or
 ...
 * the whole decl...` |
| `grammar` | function | `src/css.c:4509` | `* grammar (`justify`/`distribute`) is not `justify-content`'s. Guessing
     * there would be inv...` |
...
| `ignored` | function | `src/css.c:4342` | `* engine slot and is ignored (documented simplification, like list-style's
 * ignored tokens). An...` |
...
| `interp_flex_wrap` | function | `src/css.c:3708` | `static int interp_flex_wrap(const char *v)` |
...
| `interp_grid_flow` | function | `src/css.c:3717` | `static int interp_grid_flow(const char *v)` |
| `interp_grid_span` | function | `src/css.c:3743` | `static int interp_grid_span(const char *v)` |
...
| `interpret_decls` | function | `src/css.c:5201` | `static size_t interpret_decls(const char *s, size_t n, css_decl *dst, size_t cap,
               ...` |
| `interpret_prop` | function | `src/css.c:5077` | `static int interpret_prop(const char *prop, const char *val, css_decl *dst, int cap,
            ...` |
| `interpret_prop_dispatch` | function | `src/css.c:4490` | `static int interpret_prop_dispatch(const char *prop, const char *val, css_decl *dst, int cap,
   ...` |
...
| `media_matches` | function | `src/css.c:5440` | `static int media_matches(const char *s, size_t a, size_t b, const css_media *m)` |
| `media_part_matches` | function | `src/css.c:5374` | `static int media_part_matches(const char *p, const css_media *m)` |
| `media_segment_matches` | function | `src/css.c:5403` | `static int media_segment_matches(const char *s, size_t a, size_t b, const css_media *m)` |
| `memcpy` | function | `src/css.c:639` | `memcpy(seg, s + a, len);` |
| `memmove` | function | `src/css.c:5360` | `memmove(s, s + a, n + 1);` |
| `memset` | function | `src/css.c:5053` | `memset(tmp, 0, sizeof tmp);` |
...
| `origin_component` | function | `src/css.c:4271` | `static int origin_component(const char *tok, int axis, int *out)` |
| `overflowed` | function | `src/css.c:4011` | `* overflowed (caller drops the declaration). */
static int resolve_var(const char *val, char *out...` |
| `page_view` | function | `src/css.c:6035` | `* the generated text reaches page_view (which materialises it as a synthetic * run);` |
| `parent` | function | `src/css.c:6064` | `* property from the parent (`inherit`), and an unset non-inherited one
         * stands at its i...` |
| `parse_block` | function | `src/css.c:5528` | `static void parse_block(css_sheet *sh, const char *s, size_t start, size_t end,
                 ...` |
...
| `parse_rotate_deg` | function | `src/css.c:4045` | `static int parse_rotate_deg(const char *s, int *out)` |
...
| `property` | function | `src/css.c:4377` | `* error drops the whole property (fail closed). */
static int expand_clip(const char *val, css_de...` |
| `px` | type_alias | `src/css.c:1396` | `typedef struct calc_val { double px;` |
| `rem_emit_px` | function | `src/css.c:5752` | `static int rem_emit_px(char *out, size_t cap, size_t *o, double px)` |
| `rem_ident_ch` | function | `src/css.c:5734` | `static int rem_ident_ch(char c)` |
| `rem_num_starts_after` | function | `src/css.c:5742` | `static int rem_num_starts_after(char prev)` |
| `rem_rebase` | function | `src/css.c:5782` | `static char *rem_rebase(const char *s, size_t n, double rem_px, size_t *outlen)` |
...
| `resolve_var_rec` | function | `src/css.c:3919` | `static int resolve_var_rec(const char *val, size_t vlen, char *out, size_t outcap, size_t *o, const css_custom_prop *tab` |
| `round_clamp` | function | `src/css.c:347` | `static int round_clamp(double v, int lo, int hi)` |
| `scope_has_class` | function | `src/css.c:3855` | `static int scope_has_class(const char *list, const char *name, size_t len)` |
| `sheet_reparse` | function | `src/css.c:5997` | `sheet_reparse(sh, rebased, rlen, m, root_scope, log);` |
| `sheet_rewind` | function | `src/css.c:5849` | `static void sheet_rewind(css_sheet *sh)` |
| `sheet_root_font_px` | function | `src/css.c:5889` | `static double sheet_root_font_px(const css_sheet *sh)` |
| `shorthand` | function | `src/css.c:4420` | `* generic bucket keeps the rest of the shorthand (same net effect as the
...
| `skip_at_rule` | function | `src/css.c:5304` | `static size_t skip_at_rule(const char *s, size_t i, size_t n)` |
| `slots` | function | `src/css.c:4601` | `* expand to several slots (border / box-shadow / outline / flex). */ if (strcmp(prop, "top") == 0) return emit_len(dst, ` |
| `snprintf` | function | `src/css.c:6677` | `snprintf(family, fam_cap, "%s", sheet->font_faces[i].family);` |
| `starts_with_ci` | function | `src/css.c:1204` | `static int starts_with_ci(const char *s, const char *pre);` |
| `strcpy` | function | `src/css.c:3842` | `strcpy(tab[slot].value, valbuf);` |
| `strip_comments` | function | `src/css.c:5897` | `static char *strip_comments(const char *text, size_t len, size_t *outlen)` |
| `strip_important` | function | `src/css.c:3775` | `static int strip_important(char *val)` |
| `stylesheet` | function | `src/css.c:6565` | `* the stylesheet (e.g. a `:root` rule). Inline-declared names win on a * collision (closer to the use site), so they go ` |
...
| `translateX` | function | `src/css.c:4056` | `* translateX()/translateY() offsets in px via interp_len (allow_auto=0 -- %, * viewport units and bare non-calc numbers ` |
| `trim_inplace` | function | `src/css.c:5356` | `static void trim_inplace(char *s)` |
| `value` | function | `src/css.c:3951` | `* any other unsupported value (fail closed, never a partially-substituted value). */
static int r...` |
| `value_em_milli` | function | `src/css.c:1756` | `static int value_em_milli(const char *v)` |
| `var` | function | `src/css.c:5907` | `* collected and forty var() declarations -- font sizes, widths, radii, the
     * whole theme -- ...` |
| `var_append` | function | `src/css.c:3924` | `static int var_append(char *out, size_t outcap, size_t *o, const char *s, size_t n)` |
| `walk_tracks` | function | `src/css.c:1286` | `static int walk_tracks(const char *s, size_t n, int *sizes, int szcap, int *pos)` |
| `wide_claim` | function | `src/css.c:5037` | `static int wide_claim(const char *prop, css_decl *dst, int cap,
                      char (*urlt...` |
...
| `assert_int_equal` | function | `tests/test_css.c:1886` | `assert_int_equal(css_parse(
        "@media (hover: hover)` |
| `assert_int_equal` | function | `tests/test_css.c:4003` | `assert_int_equal(css_parse("@media (min-width: 200em)` |
| `assert_int_equal` | function | `tests/test_css.c:4009` | `assert_int_equal(css_parse("@media (min-width: 40em)` |
...
| `cmocka_run_group_tests` | function | `tests/test_css.c:4323` | `return cmocka_run_group_tests(tests, NULL, NULL);` |
...
| `main` | function | `tests/test_css.c:4079` | `int main(void)` |
...
| `test_anim_keyframes_resolved_from_sheet` | function | `tests/test_css.c:3752` | `static void test_anim_keyframes_resolved_from_sheet(void **state)` |
| `test_anim_transform_keyframes_from_sheet` | function | `tests/test_css.c:3785` | `static void test_anim_transform_keyframes_from_sheet(void **state)` |
...
| `test_backdrop_filter_blur` | function | `tests/test_css.c:3712` | `static void test_backdrop_filter_blur(void **state)` |
| `test_background_clip_text` | function | `tests/test_css.c:3587` | `static void test_background_clip_text(void **state)` |
| `test_background_rgba_alpha` | function | `tests/test_css.c:3559` | `static void test_background_rgba_alpha(void **state)` |
...
| `test_clip_auto` | function | `tests/test_css.c:4026` | `static void test_clip_auto(void **state)` |
| `test_clip_rect` | function | `tests/test_css.c:4016` | `static void test_clip_rect(void **state)` |
...
| `test_conic_gradient_basic` | function | `tests/test_css.c:3607` | `static void test_conic_gradient_basic(void **state)` |
| `test_conic_gradient_deg_positions` | function | `tests/test_css.c:3648` | `static void test_conic_gradient_deg_positions(void **state)` |
| `test_conic_gradient_fails_closed` | function | `tests/test_css.c:3658` | `static void test_conic_gradient_fails_closed(void **state)` |
| `test_conic_gradient_from_angle` | function | `tests/test_css.c:3619` | `static void test_conic_gradient_from_angle(void **state)` |
| `test_conic_gradient_pie_hard_stop` | function | `tests/test_css.c:3633` | `static void test_conic_gradient_pie_hard_stop(void **state)` |
...
| `test_filter_blur_and_grayscale` | function | `tests/test_css.c:3724` | `static void test_filter_blur_and_grayscale(void **state)` |
| `test_filter_drop_shadow` | function | `tests/test_css.c:3685` | `static void test_filter_drop_shadow(void **state)` |
| `test_filter_drop_shadow_defaults_and_failclosed` | function | `tests/test_css.c:3698` | `static void test_filter_drop_shadow_defaults_and_failclosed(void **state)` |
...
| `test_font_shorthand` | function | `tests/test_css.c:3529` | `static void test_font_shorthand(void **state)` |
| `test_gap_two_value` | function | `tests/test_css.c:3511` | `static void test_gap_two_value(void **state)` |
| `test_general_sibling_combinator` | function | `tests/test_css.c:1080` | `static void test_general_sibling_combinator(void **state)` |
| `test_grid_extras` | function | `tests/test_css.c:2717` | `static void test_grid_extras(void **state)` |
...
| `test_inline_accent_color` | function | `tests/test_css.c:3014` | `static void test_inline_accent_color(void **state)` |
| `test_inline_appearance` | function | `tests/test_css.c:2890` | `static void test_inline_appearance(void **state)` |
| `test_inline_aspect_ratio` | function | `tests/test_css.c:2343` | `static void test_inline_aspect_ratio(void **state)` |
| `test_inline_backface_visibility` | function | `tests/test_css.c:3395` | `static void test_inline_backface_visibility(void **state)` |
| `test_inline_bg_clip_origin_attachment` | function | `tests/test_css.c:2943` | `static void test_inline_bg_clip_origin_attachment(void **state)` |
| `test_inline_bg_repeat` | function | `tests/test_css.c:2923` | `static void test_inline_bg_repeat(void **state)` |
| `test_inline_bg_size` | function | `tests/test_css.c:2934` | `static void test_inline_bg_size(void **state)` |
| `test_inline_border_collapse` | function | `tests/test_css.c:2803` | `static void test_inline_border_collapse(void **state)` |
| `test_inline_border_spacing` | function | `tests/test_css.c:2812` | `static void test_inline_border_spacing(void **state)` |
| `test_inline_box_longhands` | function | `tests/test_css.c:1924` | `static void test_inline_box_longhands(void **state)` |
| `test_inline_caption_side` | function | `tests/test_css.c:2832` | `static void test_inline_caption_side(void **state)` |
| `test_inline_caret_color` | function | `tests/test_css.c:2880` | `static void test_inline_caret_color(void **state)` |
| `test_inline_color_scheme` | function | `tests/test_css.c:3004` | `static void test_inline_color_scheme(void **state)` |
| `test_inline_contain` | function | `tests/test_css.c:2971` | `static void test_inline_contain(void **state)` |
| `test_inline_container_props` | function | `tests/test_css.c:326` | `static void test_inline_container_props(void **state)` |
| `test_inline_content_visibility` | function | `tests/test_css.c:2986` | `static void test_inline_content_visibility(void **state)` |
...
| `test_inline_empty_cells` | function | `tests/test_css.c:2823` | `static void test_inline_empty_cells(void **state)` |
| `test_inline_font_kerning` | function | `tests/test_css.c:3325` | `static void test_inline_font_kerning(void **state)` |
...
| `test_inline_font_stretch` | function | `tests/test_css.c:3344` | `static void test_inline_font_stretch(void **state)` |
| `test_inline_font_variant` | function | `tests/test_css.c:2850` | `static void test_inline_font_variant(void **state)` |
| `test_inline_font_weight_style` | function | `tests/test_css.c:97` | `static void test_inline_font_weight_style(void **state)` |
| `test_inline_hyphens` | function | `tests/test_css.c:2859` | `static void test_inline_hyphens(void **state)` |
| `test_inline_image_rendering` | function | `tests/test_css.c:2995` | `static void test_inline_image_rendering(void **state)` |
| `test_inline_isolation` | function | `tests/test_css.c:2963` | `static void test_inline_isolation(void **state)` |
| `test_inline_line_height` | function | `tests/test_css.c:82` | `static void test_inline_line_height(void **state)` |
| `test_inline_list_style_pos` | function | `tests/test_css.c:3317` | `static void test_inline_list_style_pos(void **state)` |
...
| `test_inline_mix_blend_mode` | function | `tests/test_css.c:3037` | `static void test_inline_mix_blend_mode(void **state)` |
| `test_inline_object_fit` | function | `tests/test_css.c:3306` | `static void test_inline_object_fit(void **state)` |
| `test_inline_outline_longhands` | function | `tests/test_css.c:2772` | `static void test_inline_outline_longhands(void **state)` |
| `test_inline_outline_offset` | function | `tests/test_css.c:2382` | `static void test_inline_outline_offset(void **state)` |
| `test_inline_overscroll_behavior` | function | `tests/test_css.c:3386` | `static void test_inline_overscroll_behavior(void **state)` |
| `test_inline_pointer_events` | function | `tests/test_css.c:2899` | `static void test_inline_pointer_events(void **state)` |
| `test_inline_print_forced_adjust` | function | `tests/test_css.c:3023` | `static void test_inline_print_forced_adjust(void **state)` |
| `test_inline_resize` | function | `tests/test_css.c:3359` | `static void test_inline_resize(void **state)` |
| `test_inline_scroll_behavior` | function | `tests/test_css.c:3369` | `static void test_inline_scroll_behavior(void **state)` |
| `test_inline_tab_size` | function | `tests/test_css.c:2394` | `static void test_inline_tab_size(void **state)` |
| `test_inline_table_layout` | function | `tests/test_css.c:2841` | `static void test_inline_table_layout(void **state)` |
...
| `test_inline_text_rendering` | function | `tests/test_css.c:3334` | `static void test_inline_text_rendering(void **state)` |
| `test_inline_touch_action` | function | `tests/test_css.c:3377` | `static void test_inline_touch_action(void **state)` |
| `test_inline_transform_independent_cascade_combines` | function | `tests/test_css.c:3293` | `static void test_inline_transform_independent_cascade_combines(void **state)` |
| `test_inline_transform_rotate` | function | `tests/test_css.c:3142` | `static void test_inline_transform_rotate(void **state)` |
| `test_inline_transform_scale` | function | `tests/test_css.c:3103` | `static void test_inline_transform_scale(void **state)` |
| `test_inline_transform_skew` | function | `tests/test_css.c:3173` | `static void test_inline_transform_skew(void **state)` |
| `test_inline_transform_translate` | function | `tests/test_css.c:3059` | `static void test_inline_transform_translate(void **state)` |
| `test_inline_user_select` | function | `tests/test_css.c:2869` | `static void test_inline_user_select(void **state)` |
| `test_keyframes_overflow_skips_block_not_sheet` | function | `tests/test_css.c:3857` | `static void test_keyframes_overflow_skips_block_not_sheet(void **state)` |
| `test_layout_sheet_cascade_and_unset` | function | `tests/test_css.c:2735` | `static void test_layout_sheet_cascade_and_unset(void **state)` |
...
| `test_linear_gradient_positions_emitted` | function | `tests/test_css.c:3668` | `static void test_linear_gradient_positions_emitted(void **state)` |
...
| `test_logical_inset_and_sizes` | function | `tests/test_css.c:3466` | `static void test_logical_inset_and_sizes(void **state)` |
| `test_logical_margin_padding` | function | `tests/test_css.c:3441` | `static void test_logical_margin_padding(void **state)` |
| `test_malformed_inline_no_crash` | function | `tests/test_css.c:716` | `static void test_malformed_inline_no_crash(void **state)` |
| `test_math_clamp` | function | `tests/test_css.c:3416` | `static void test_math_clamp(void **state)` |
| `test_math_min_max_top_level` | function | `tests/test_css.c:3405` | `static void test_math_min_max_top_level(void **state)` |
| `test_math_nested_in_calc` | function | `tests/test_css.c:3426` | `static void test_math_nested_in_calc(void **state)` |
...
| `test_media_query_length_honours_its_unit` | function | `tests/test_css.c:3995` | `static void test_media_query_length_honours_its_unit(void **state)` |
...
| `test_place_shorthands` | function | `tests/test_css.c:3489` | `static void test_place_shorthands(void **state)` |
...
| `test_rem_rebase_62_5_percent_idiom` | function | `tests/test_css.c:3980` | `static void test_rem_rebase_62_5_percent_idiom(void **state)` |
| `test_rem_rebase_absent_root_declaration_is_byte_identical` | function | `tests/test_css.c:3909` | `static void test_rem_rebase_absent_root_declaration_is_byte_identical(void **state)` |
| `test_rem_rebase_applies_to_box_lengths` | function | `tests/test_css.c:3895` | `static void test_rem_rebase_applies_to_box_lengths(void **state)` |
| `test_rem_rebase_honours_root_pseudo_class` | function | `tests/test_css.c:3921` | `static void test_rem_rebase_honours_root_pseudo_class(void **state)` |
| `test_rem_rebase_ignores_identifier_lookalikes` | function | `tests/test_css.c:3965` | `static void test_rem_rebase_ignores_identifier_lookalikes(void **state)` |
| `test_rem_rebase_leaves_quoted_text_alone` | function | `tests/test_css.c:3954` | `static void test_rem_rebase_leaves_quoted_text_alone(void **state)` |
| `test_rem_rebase_skips_at_rule_prelude` | function | `tests/test_css.c:3931` | `static void test_rem_rebase_skips_at_rule_prelude(void **state)` |
| `test_rem_rebased_on_root_font_size` | function | `tests/test_css.c:3883` | `static void test_rem_rebased_on_root_font_size(void **state)` |
...
| `test_table_sheet_cascade` | function | `tests/test_css.c:2908` | `static void test_table_sheet_cascade(void **state)` |
...
| `test_text_fill_color` | function | `tests/test_css.c:3596` | `static void test_text_fill_color(void **state)` |
...
| `test_transform_origin` | function | `tests/test_css.c:3251` | `static void test_transform_origin(void **state)` |
...
| `test_vendor_prefixes` | function | `tests/test_css.c:4044` | `static void test_vendor_prefixes(void **state)` |
...
| `test_white_space_break_spaces` | function | `tests/test_css.c:3551` | `static void test_white_space_break_spaces(void **state)` |
...
| `cmocka_run_group_tests` | function | `tests/test_css_drops.c:417` | `return cmocka_run_group_tests(tests, NULL, NULL);` |
...
| `main` | function | `tests/test_css_drops.c:387` | `int main(void)` |
...
| `test_background_position_percentages` | function | `tests/test_css_drops.c:291` | `static void test_background_position_percentages(void **state)` |
| `test_background_size_two_lengths` | function | `tests/test_css_drops.c:280` | `static void test_background_size_two_lengths(void **state)` |
...
| `test_css_wide_keyword_on_shorthand` | function | `tests/test_css_drops.c:321` | `static void test_css_wide_keyword_on_shorthand(void **state)` |
...
| `test_font_shorthand_with_line_height` | function | `tests/test_css_drops.c:379` | `static void test_font_shorthand_with_line_height(void **state)` |
...
| `test_intrinsic_sizing_keywords` | function | `tests/test_css_drops.c:357` | `static void test_intrinsic_sizing_keywords(void **state)` |
...
| `test_overflow_two_values` | function | `tests/test_css_drops.c:331` | `static void test_overflow_two_values(void **state)` |
...
| `test_vendor_prefixed_value_keyword` | function | `tests/test_css_drops.c:369` | `static void test_vendor_prefixed_value_keyword(void **state)` |
| `test_vertical_align_length` | function | `tests/test_css_drops.c:310` | `static void test_vertical_align_length(void **state)` |
...
| `main` | function | `tests/test_freedom.c:1888` | `int main(void)` |
...
| `sample_png_pixel` | function | `tests/test_freedom.c:1772` | `sample_png_pixel(html, "--author-css", "gradrow", 900, 85, &r, &g, &b);` |
...
| `test_download_png_flex_container_paints_one_band` | function | `tests/test_freedom.c:1784` | `static void test_download_png_flex_container_paints_one_band(void **state)` |
| `test_download_png_gradient_box_text_keeps_gradient` | function | `tests/test_freedom.c:1759` | `static void test_download_png_gradient_box_text_keeps_gradient(void **state)` |
...
| `test_download_png_inline_block_shrinks_and_centers` | function | `tests/test_freedom.c:1804` | `static void test_download_png_inline_block_shrinks_and_centers(void **state)` |
| `test_download_png_inline_svg_path_and_drops_image` | function | `tests/test_freedom.c:1848` | `static void test_download_png_inline_svg_path_and_drops_image(void **state)` |
...
| `test_dump_timings_prints_stages` | function | `tests/test_freedom.c:1864` | `static void test_dump_timings_prints_stages(void **state)` |
...
| `test_rejects_http_url` | function | `tests/test_freedom.c:1600` | `static void test_rejects_http_url(void **state)` |
...
| `white` | function | `tests/test_freedom.c:1663` | `* and not white (the old behaviour where only text rows got background fills). */
static void tes...` |
