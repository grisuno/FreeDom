...
- `src/dom.c` (score: 6.30)

## Hotspots (complexity + centrality)

- `gui/browser_ui.c` -- complexity: 1.0, centrality: 1.0, combined: 1.0
- `src/local_store.c` -- complexity: 0.7, centrality: 1.0, combined: 0.9
...
- `tests/test_js_dom.c` -- complexity: 0.3, centrality: 0.2, combined: 0.2
