...
| Video/Audio | `media_decoder` (`md_`), `hls` | FFmpeg pipeline para H.264/H.265 desde MPEG-TS o `.m3u8` HLS. `<video>` y `<audio>` reproducidos en el worker confinado. Integración jkanime: extracción de iframe→.m3u8/.mp4. |
