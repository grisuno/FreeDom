...
medición (ago 11, tanda 14, `TOTAL 145.10`): `jkanime` 53.77, `wikipedia` 43.62, `ddg-results` 15.24,
`slashdot` 14.98, `hackernews` 12.75, `table-fit` 1.64, `float-beside` 1.23, `ua-metrics` 0.98,
