 ...
 * href is owned and NUL-terminated for PV_LINK runs, NULL otherwise. */
...
/* Appends one run, copying text (required) and href (NULL for non-links). text
 * is normalised to valid UTF-8. Returns PV_OK or PV_ERR_OOM / PV_ERR_NULL_ARG. */
